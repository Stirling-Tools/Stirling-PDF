...
const meta: Meta<typeof StatusBadge> = {
  ...
  argTypes: {
    tone: { control: 'inline-radio', options: ['neutral', 'success', 'warning', 'danger', 'info', 'purple'] },
...
export const Sizes: Story = {
  render: () => (
    <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
      <StatusBadge tone="info" size="sm">Small</StatusBadge>
      <StatusBadge tone="info" size="md">Medium</StatusBadge>
      <StatusBadge tone="info" size="lg">Large</StatusBadge>
    </div>
  ),
};
