...
try {
  for (const artifact of artifacts) {
    const stagingDirectory = path.join(publisherRoot, "cache-staging");
    const stagingRoot = path.join(stagingDirectory, ".cache", artifact.cacheName);
