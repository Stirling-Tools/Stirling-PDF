class PdfActionsManager {
  ...
  adapt(div) {
    ...
    moveUp.classList.add(
      "pdf-actions_move-left-button",
      "btn",
      "btn-secondary",
    );
    ...
    moveDown.classList.add(
      "pdf-actions_move-right-button",
      "btn",
      "btn-secondary",
    );
    ...
    insertFileButton.classList.add(
      "btn",
      "btn-primary",
    ...
    insertFileButtonRight.classList.add(
      "btn",
      "btn-primary",
      "pdf-actions_insert-file-button",
    );
