...
INSERT INTO "PUBLIC"."USERS"("USER_ID", "API_KEY", "AUTHENTICATIONTYPE", "ENABLED", "IS_FIRST_LOGIN", "PASSWORD", "ROLE_NAME", "USERNAME") VALUES(2, NULL, 'web', TRUE, FALSE, '$2a$10$QEiRUhcwVVoaufp4QhxJduhy2JgQpmZ0LGQpXFaqiVYOL95FrhaMC', NULL, 'STIRLING-PDF-BACKEND-API-USER');        
