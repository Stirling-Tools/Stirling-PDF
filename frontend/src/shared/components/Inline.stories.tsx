...
export const SpaceBetween: Story = {
  render: () => (
    <Inline justify="between" style={{ width: "30rem", padding: 12, border: "1px solid var(--color-border)", borderRadius: 8 }}>
      <span>Pipeline name</span>
      <StatusBadge tone="success" pulse>healthy</StatusBadge>
    </Inline>
  ),
};
