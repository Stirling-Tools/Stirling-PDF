 ...
 */
export function PanelHeader({ title, subtitle, onBack, actions, className }: PanelHeaderProps) {
  return (
    <div className={['sui-panelhdr', className ?? ''].filter(Boolean).join(' ')}>
      <div className="sui-panelhdr__left">
        {onBack && (
          <button type="button" className="sui-panelhdr__back" onClick={onBack} aria-label="Back">
