  ...
  return {
    ...
    tips: [
      ...
      },
      {
        ...
        description: t(
          "compress.tooltip.grayscale.text",
          "Select this option to convert all images to black and white, which can significantly reduce file size especially for scanned PDFs or image-heavy documents.",
        ),
      },
      {
