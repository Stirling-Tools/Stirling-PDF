...
export const useFlattenTips = (): TooltipContent => {
  ...
  return {
    ...
    tips: [
      {
        title: t(
          "flatten.tooltip.description.title",
        ...
        bullets: [
          t(
            "flatten.tooltip.description.bullet1",
            "Text boxes become regular text (can't be edited)",
          ),
          t(
            "flatten.tooltip.description.bullet2",
            "Checkboxes and buttons become pictures",
          ),
          t(
      ...
      {
        title: t(
          "flatten.tooltip.formsOnly.title",
          "What does 'Flatten only forms' mean?",
        ),
        description: t(
          "flatten.tooltip.formsOnly.text",
          "This option only removes the ability to fill in forms, but keeps other features working like clicking links, viewing bookmarks, and reading comments.",
        ),
        bullets: [
          t("flatten.tooltip.formsOnly.bullet1", "Forms become non-editable"),
          t(
            "flatten.tooltip.formsOnly.bullet2",
            "Links still work when clicked",
          ),
          t(
            "flatten.tooltip.formsOnly.bullet3",
            "Comments and notes remain visible",
          ),
          t(
            "flatten.tooltip.formsOnly.bullet4",
            "Bookmarks still help you navigate",
          ),
        ],
      },
    ],
