...
function ModernLogoIcon({ alt, className = "", ...props }: LogoIconProps) {
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d="M0 50L60 0V46.5L0 96.5V50Z" className="logo-icon-modern__path1" />
      <path d="M32 53L92 3V49.5L32 99.5V53Z" className="logo-icon-modern__path2" />
    </svg>
  );
}

function ClassicLogoIcon({ alt, className = "", ...props }: LogoIconProps) {
  const a11y = alt ? { role: "img" as const, "aria-label": alt } : { "aria-hidden": true as const };
  return (
    <svg
      width="82"
      ...
      {...props}
    >
      <g className="logo-icon-classic__group" filter="url(#stirling-classic-logo-filter)">
        <path
          d="M56.3678 0.557543L9.07973 10.0315C4.2844 10.989 0.875 14.8441 0.875 19.3039V73.9053C0.875 77.7856 4.06265 81.0359 8.27589 81.4895L33.0841 84.4375L54.9327 64.6642L77.1014 44.0219L76.7133 12.778C76.6579 8.97326 72.7773 6.15122 68.7027 6.95752L63.2143 8.04098L63.2421 5.67248C63.2975 2.34651 59.9158 -0.147965 56.3678 0.557543Z"
          className="logo-icon-classic__body"
        />
        <path
      ...
      <defs>
        <filter
          id="stirling-classic-logo-filter"
          x="-8.34465e-07"
          y="-4.17233e-07"
          width="81.0944"
          height="91.875"
...
export function LogoIcon({ alt, className = "", ...props }: LogoIconProps) {
  const logoVariant = useLogoVariant();
  if (logoVariant === "modern") {
    return <ModernLogoIcon alt={alt} className={className} {...props} />;
  }
  return <ClassicLogoIcon alt={alt} className={className} {...props} />;
}
