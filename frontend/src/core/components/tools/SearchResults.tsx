          ...
          <Stack gap="xs">
            {group.tools.map(({ id, tool }) => {
              ...
              const isSynonymMatch =
                matchedText && tool.synonyms?.some((synonym) => matchedText.toLowerCase().includes(synonym.toLowerCase()));
              const matchedSynonym = isSynonymMatch
                ? tool.synonyms?.find((synonym) => matchedText.toLowerCase().includes(synonym.toLowerCase()))
                : undefined;
