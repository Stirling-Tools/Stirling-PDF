...
describe("AdjustPageScaleSettings", () => {
  ...
  test("should render without crashing", () => {
    render(
      <TestWrapper>
        <AdjustPageScaleSettings parameters={defaultParameters} onParameterChange={mockOnParameterChange} />
      </TestWrapper>,
    );
  ...
  test("should render with custom parameters", () => {
    ...
    render(
      <TestWrapper>
        <AdjustPageScaleSettings parameters={customParameters} onParameterChange={mockOnParameterChange} />
      </TestWrapper>,
    );
