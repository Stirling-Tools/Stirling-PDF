...
describe("AddPasswordSettings", () => {
  ...
  test("should render password input fields", () => {
    render(
      <TestWrapper>
        <AddPasswordSettings parameters={defaultParameters} onParameterChange={mockOnParameterChange} />
      </TestWrapper>,
    );
  ...
  test("should disable all form elements when disabled prop is true", () => {
    render(
      <TestWrapper>
        <AddPasswordSettings parameters={defaultParameters} onParameterChange={mockOnParameterChange} disabled={true} />
      </TestWrapper>,
    );
  ...
  test("should enable all form elements when disabled prop is false", () => {
    render(
      <TestWrapper>
        <AddPasswordSettings parameters={defaultParameters} onParameterChange={mockOnParameterChange} disabled={false} />
      </TestWrapper>,
    );
  ...
  test.each([
    ...
    render(
      <TestWrapper>
        <AddPasswordSettings parameters={{ ...defaultParameters, keyLength }} onParameterChange={mockOnParameterChange} />
      </TestWrapper>,
    );
