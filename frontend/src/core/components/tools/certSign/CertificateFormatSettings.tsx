    ...
    <Stack gap="md">
      <div style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
        ...
        <div style={{ display: "flex", gap: "4px" }}>
          ...
          >
            <div style={{ textAlign: "center", lineHeight: "1.1", fontSize: "11px" }}>PKCS12</div>
          </Button>
          <Button
            ...
            style={{ flex: 1, height: "auto", minHeight: "40px", fontSize: "11px" }}
          >
            <div style={{ textAlign: "center", lineHeight: "1.1", fontSize: "11px" }}>PFX</div>
          </Button>
        </div>
        ...
        <div style={{ display: "flex", gap: "4px" }}>
          <Button
            ...
            style={{ flex: 1, height: "auto", minHeight: "40px", fontSize: "11px" }}
          >
            <div style={{ textAlign: "center", lineHeight: "1.1", fontSize: "11px" }}>PEM</div>
          </Button>
          <Button
            ...
            style={{ flex: 1, height: "auto", minHeight: "40px", fontSize: "11px" }}
          >
            <div style={{ textAlign: "center", lineHeight: "1.1", fontSize: "11px" }}>JKS</div>
          </Button>
        </div>
      </div>
    </Stack>
