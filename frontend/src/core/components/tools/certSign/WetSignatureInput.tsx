...
import { Stack, SegmentedControl, Text, Radio, FileInput, PasswordInput, Divider } from "@mantine/core";
  ...
  return (
    <Stack gap="md">
      ...
      <Stack gap="xs">
        ...
        <Radio.Group value={certType} onChange={(value) => onCertTypeChange(value as CertificateType)}>
          <Stack gap="xs">
            <Radio
              value="USER_CERT"
