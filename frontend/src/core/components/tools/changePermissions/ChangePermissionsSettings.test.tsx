...
describe("ChangePermissionsSettings", () => {
  ...
  test("should render all permission checkboxes", () => {
    render(
      <TestWrapper>
        <ChangePermissionsSettings parameters={defaultParameters} onParameterChange={mockOnParameterChange} />
      </TestWrapper>,
    );
  ...
  test("should show checkboxes as checked when parameters are true", () => {
    ...
    render(
      <TestWrapper>
        <ChangePermissionsSettings parameters={checkedParameters} onParameterChange={mockOnParameterChange} />
      </TestWrapper>,
    );
  ...
  test.each([
    ...
    render(
      <TestWrapper>
        <ChangePermissionsSettings parameters={testParameters} onParameterChange={mockOnParameterChange} />
      </TestWrapper>,
    );
  ...
  test.each(Object.keys(defaultParameters) as Array<keyof ChangePermissionsParameters>)(
    "should handle %s permission type individually",
    (permission) => {
      const testParameters: ChangePermissionsParameters = {
        ...defaultParameters,
        [permission]: true,
