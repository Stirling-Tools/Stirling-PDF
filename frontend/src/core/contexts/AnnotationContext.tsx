...
interface AnnotationContextValue {
  ...
  activateAnnotationToolRef: React.RefObject<((toolId: AnnotationToolId) => void) | null>;
}
...
export const AnnotationProvider: React.FC<{ children: ReactNode }> = ({
  ...
  const activateAnnotationToolRef = useRef<((toolId: AnnotationToolId) => void) | null>(null);
