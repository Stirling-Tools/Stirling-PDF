...
test.describe('16. File Menu', () => {
  ...
  test.describe('16.1 File Menu - Open and Contents', () => {
    test('should open file menu and display file management options', async ({ page }) => {
      ...
      const filePanel = page.locator('.mantine-Modal-content, .mantine-Drawer-content, [role="dialog"]').first();
