...
export const HotkeysSection: React.FC = () => {
  ...
  const { hotkeys, defaults, updateHotkey, resetHotkey, pauseHotkeys, resumeHotkeys, getDisplayParts } = useHotkeys();
  ...
  useEffect(() => {
    ...
    const handleKeyDown = (event: KeyboardEvent) => {
      ...
      if (!binding) {
        setError(t('settings.hotkeys.errorModifier', 'Include Ctrl/⌘, Alt/⌥, or another modifier in your shortcut.'));
        return;
      }
    ...
    <Stack gap="lg">
      <div>
        ...
        <Text size="sm" c="dimmed">
          {t('settings.hotkeys.description', 'Hover a tool to see its shortcut or customise it below. Click “Change shortcut” and press a new key combination. Press Esc to cancel.')}
        </Text>
      </div>
