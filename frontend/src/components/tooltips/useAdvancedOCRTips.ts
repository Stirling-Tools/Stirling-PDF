    ...
    tips: [
      {
        ...
        description: t("ocr.tooltip.advanced.compatibility.text", "Creates a 'sandwich PDF' with searchable text behind the original image for maximum compatibility with older PDF viewers and software.")
      },
      {
