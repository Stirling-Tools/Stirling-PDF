...
import { SpringAuthProvider } from "@editor/auth/spring/UseSession";
import { type AuthMode, type AuthTranslate } from "@editor/auth/types";
...
const SupabaseAuthProvider = lazy(() =>
  import("@editor/auth/supabase/UseSession").then((m) => ({
