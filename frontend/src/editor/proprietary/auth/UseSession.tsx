...
import { useAuth as useSharedAuth } from "@editor/auth/context";
import type { AuthUser } from "@editor/auth/types";
...
import "@editor/auth/configureSpringAuth";

export type { AuthUser as User } from "@editor/auth/types";
