...
import { ClassificationCategoryManager } from "@editor/components/policies/ClassificationCategoryManager";
import type { SidebarCategory } from "@editor/services/fileSidebarCategories";
