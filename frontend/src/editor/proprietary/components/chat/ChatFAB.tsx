...
import { ChatPanel } from "@editor/components/chat/ChatPanel";
import { useChat } from "@editor/components/chat/ChatContext";
import { useAiEngineEnabled } from "@editor/hooks/useAiEngineEnabled";
import { Z_INDEX_CHAT_FAB_OVERLAY } from "@editor/styles/zIndex";
import {
  PANEL_WIDTH_PX,
  PANEL_HEIGHT_PX,
  PANEL_MIN_WIDTH_PX,
  ...
  clampToOverlay,
  defaultPanelPos,
} from "@editor/components/chat/chatFabLayout";
import "@editor/components/chat/ChatFAB.css";
