...
vi.mock("@editor/services/apiClient", () => ({ default: { get: h.get } }));
vi.mock("@editor/contexts/PreferencesContext", () => ({
...
import { LoginLandingSetting } from "@editor/components/shared/config/LoginLandingSetting";
