// Supabase client. Relocated out of frontend/src/editor/core/services/ during the SaaS<->OSS
...
// :saas mode bundle picks it up via the existing @editor/* path mapping (saas to proprietary
// to core).
