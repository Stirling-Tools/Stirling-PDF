 ...
 *
 * The Vitest suites in `src/editor/core/tests/` run these over every entry in
...
const HERE = path.dirname(fileURLToPath(import.meta.url)); // frontend/src/editor/core/i18n
...
export const I18N_PROJECTS: TranslationProject[] = [
  {
    ...
    // like any other key.
    srcRoot: front("src"),
    localeFile: front("public/locales/en-US/translation.toml"),
    ignoredKeyPatterns: [
