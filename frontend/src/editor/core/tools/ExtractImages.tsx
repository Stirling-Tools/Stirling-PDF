...
import { useExtractImagesParameters } from "@editor/hooks/tools/extractImages/useExtractImagesParameters";
import { useExtractImagesOperation } from "@editor/hooks/tools/extractImages/useExtractImagesOperation";
