...
import { createStirlingFilesAndStubs } from "@editor/services/fileStubHelpers";
import { BaseToolProps, ToolComponent } from "@editor/types/tool";
import type { FileId } from "@editor/types/file";
import { getDefaultWorkbench } from "@editor/types/workbench";
import { CONVERSION_ENDPOINTS } from "@editor/constants/convertConstants";
import apiClient from "@editor/services/apiClient";
import { downloadBlob, downloadTextAsFile } from "@editor/utils/downloadUtils";
import { getFilenameFromHeaders } from "@editor/utils/fileResponseUtils";
import { pdfWorkerManager } from "@editor/services/pdfWorkerManager";
...
import {
  ...
  BoundingBox,
  ConversionProgress,
} from "@editor/tools/pdfTextEditor/pdfTextEditorTypes";
import {
  deepCloneDocument,
  getDirtyPages,
  groupDocumentText,
  ...
  cloneTextElement,
  valueOr,
} from "@editor/tools/pdfTextEditor/pdfTextEditorUtils";
import PdfTextEditorView from "@editor/components/tools/pdfTextEditor/PdfTextEditorView";
import PdfTextEditorSidebar from "@editor/components/tools/pdfTextEditor/PdfTextEditorSidebar";
