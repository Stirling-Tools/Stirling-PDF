...
import DocumentStack from "@editor/components/shared/filePreview/DocumentStack";
import HoverOverlay from "@editor/components/shared/filePreview/HoverOverlay";
