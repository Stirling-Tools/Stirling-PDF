...
import { SettingsSearchBar } from "@editor/components/shared/config/SettingsSearchBar";
import type { ConfigNavSection } from "@editor/components/shared/config/configNavSections";
