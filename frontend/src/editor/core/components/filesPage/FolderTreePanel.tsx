...
import { useFilesPage } from "@editor/contexts/FilesPageContext";
import { useFolders } from "@editor/contexts/FolderContext";
import { FileId } from "@editor/types/file";
import { FolderId, FolderRecord } from "@editor/types/folder";
import {
  MIN_WIDTH,
  MAX_WIDTH,
  clamp,
  ...
  loadPersistedWidth,
  savePersistedWidth,
} from "@editor/components/filesPage/folderTreeWidth";

import "@editor/components/filesPage/FolderTreePanel.css";
