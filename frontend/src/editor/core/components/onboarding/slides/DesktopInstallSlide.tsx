...
import { UNIFIED_LIGHT_BACKGROUND } from "@editor/components/onboarding/slides/unifiedBackgroundConfig";
import {
  DesktopInstallTitle,
  type OSOption,
} from "@editor/components/onboarding/slides/DesktopInstallTitle";
