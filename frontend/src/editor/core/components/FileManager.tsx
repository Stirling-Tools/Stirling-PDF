...
import { useFileManager } from "@editor/hooks/useFileManager";
...
import MobileLayout from "@editor/components/fileManager/MobileLayout";
import DesktopLayout from "@editor/components/fileManager/DesktopLayout";
import DragOverlay from "@editor/components/fileManager/DragOverlay";
import { FileManagerProvider } from "@editor/contexts/FileManagerContext";
import { Z_INDEX_FILE_MANAGER_MODAL } from "@editor/styles/zIndex";
import {
  isGoogleDriveConfigured,
  extractGoogleDriveBackendConfig,
} from "@editor/services/googleDrivePickerService";
import { loadScript } from "@editor/utils/scriptLoader";
 ...
 * string array. Both `Tool` (from `@editor/types/tool`) and `ToolRegistryEntry`
 * (from `@editor/data/toolsTaxonomy`) satisfy this, so callers can pass either
