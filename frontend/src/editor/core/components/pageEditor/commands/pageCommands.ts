...
import { PDFDocument, PDFPage, PageBreakSettings } from "@editor/types/pageEditor";
  ...
  private async generateThumbnailsForInsertedPages(
    ...
    try {
      const { thumbnailGenerationService } =
        await import("@editor/services/thumbnailGenerationService");
      ...
      reader.onload = async (event) => {
        try {
          ...
          const { pdfWorkerManager } =
            await import("@editor/services/pdfWorkerManager");
