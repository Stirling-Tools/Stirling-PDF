...
import { PageEditorFunctions, PDFPage } from "@editor/types/pageEditor";
// Thumbnail generation is now handled by individual PageThumbnail components
import "@editor/components/pageEditor/PageEditor.module.css";
import PageThumbnail from "@editor/components/pageEditor/PageThumbnail";
import DragDropGrid from "@editor/components/pageEditor/DragDropGrid";
import SkeletonLoader from "@editor/components/shared/SkeletonLoader";
import { FileId } from "@editor/types/file";
import { GRID_CONSTANTS } from "@editor/components/pageEditor/constants";
import { useInitialPageDocument } from "@editor/components/pageEditor/hooks/useInitialPageDocument";
import { usePageDocument } from "@editor/components/pageEditor/hooks/usePageDocument";
import { usePageEditorState } from "@editor/components/pageEditor/hooks/usePageEditorState";
import { usePageEditorWorkbenchBarButtons } from "@editor/components/pageEditor/pageEditorWorkbenchBarButtons";
import { useFileColorMap } from "@editor/components/pageEditor/hooks/useFileColorMap";
import { useWheelZoom } from "@editor/hooks/useWheelZoom";
import { useEditedDocumentState } from "@editor/components/pageEditor/hooks/useEditedDocumentState";
import { useUndoManagerState } from "@editor/components/pageEditor/hooks/useUndoManagerState";
import { usePageSelectionManager } from "@editor/components/pageEditor/hooks/usePageSelectionManager";
import { usePageEditorCommands } from "@editor/components/pageEditor/hooks/useEditorCommands";
import { usePageEditorExport } from "@editor/components/pageEditor/hooks/usePageEditorExport";
import { useThumbnailGeneration } from "@editor/hooks/useThumbnailGeneration";
import { convertSplitPageIdsToIndexes } from "@editor/components/pageEditor/utils/splitPositions";
