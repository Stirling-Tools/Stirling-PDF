...
import { usePageEditor } from "@editor/contexts/PageEditorContext";
import { shallowEqual, useFileSelector } from "@editor/contexts/FileContext";
import { FileId } from "@editor/types/file";
import { useFileColorMap } from "@editor/components/pageEditor/hooks/useFileColorMap";
