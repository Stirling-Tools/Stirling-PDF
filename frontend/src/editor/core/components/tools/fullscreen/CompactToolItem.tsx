...
import HotkeyDisplay from "@editor/components/hotkeys/HotkeyDisplay";
import FavoriteStar from "@editor/components/tools/toolPicker/FavoriteStar";
import {
  ToolRegistryEntry,
  getSubcategoryColor,
...
import {
  ...
  useToolMeta,
  getDisabledLabel,
} from "@editor/components/tools/fullscreen/shared";
