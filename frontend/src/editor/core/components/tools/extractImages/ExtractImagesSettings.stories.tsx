...
import ExtractImagesSettings from "@editor/components/tools/extractImages/ExtractImagesSettings";
import {
  ExtractImagesParameters,
  defaultParameters,
} from "@editor/hooks/tools/extractImages/useExtractImagesParameters";
