...
import AutoRenameSettings from "@editor/components/tools/autoRename/AutoRenameSettings";
import { AutoRenameParameters } from "@editor/hooks/tools/autoRename/useAutoRenameParameters";
