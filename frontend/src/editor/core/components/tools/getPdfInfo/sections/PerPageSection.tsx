...
import { pdfInfoAccordionStyles } from "@editor/components/tools/getPdfInfo/shared/accordionStyles";
...
const PerPageSection: React.FC<PerPageSectionProps> = ({
  anchorId,
  perPage,
}) => {
  ...
  return (
    <SectionBlock
      title={t("getPdfInfo.sections.perPageInfo", "Per Page Info")}
      anchorId={anchorId}
    >
      {hasPages ? (
        <Accordion
        ...
        >
          {Object.entries(perPage).map(
            ([pageLabel, pageInfo]: [string, PdfPageInfo]) => (
                      ...
                      <KeyValueList
                        obj={{
                          ...
                          "Text Characters Count":
                            pageInfo?.["Text Characters Count"],
                        }}
                      />
