...
import ScrollableCodeBlock from "@editor/components/tools/getPdfInfo/shared/ScrollableCodeBlock";
...
const OtherSection: React.FC<OtherSectionProps> = ({ anchorId, other }) => {
  ...
  return (
    <SectionBlock
      title={t("getPdfInfo.sections.other", "Other")}
      anchorId={anchorId}
    >
      <Stack gap="sm">
        <Stack gap={6}>
