...
import { defaultParameters } from "@editor/hooks/tools/redact/useRedactParameters";
...
describe("RedactAdvancedSettings", () => {
  ...
  test.each([
    ...
    "should call onParameterChange when $paramName checkbox is toggled",
    ({ paramName, label, initialValue, expectedValue }) => {
      const customParameters = {
        ...defaultParameters,
