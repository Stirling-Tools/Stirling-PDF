...
import RemovePagesSettings from "@editor/components/tools/removePages/RemovePagesSettings";
import { RemovePagesParameters } from "@editor/hooks/tools/removePages/useRemovePagesParameters";
