...
import { SignaturePreviewLayer } from "@editor/components/viewer/SignaturePreviewLayer";
import type { SignaturePreview } from "@editor/components/viewer/viewerTypes";
