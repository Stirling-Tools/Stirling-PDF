    ...
    tips: [
      {
        ...
        bullets: [
          t(
            "wetSignature.tooltip.draw.bullet1",
            "Customize pen color and thickness",
          ),
          t(
            "wetSignature.tooltip.draw.bullet2",
            "Clear and redraw until satisfied",
          ),
          t(
            "wetSignature.tooltip.draw.bullet3",
      ...
      },
      {
        ...
        bullets: [
          t(
            "wetSignature.tooltip.upload.bullet1",
            "Supports PNG, JPG, and other image formats",
          ),
          t(
            "wetSignature.tooltip.upload.bullet2",
            "Transparent backgrounds recommended for best results",
          ),
          t(
            "wetSignature.tooltip.upload.bullet3",
            "Image will be resized to fit signature area",
          ),
        ],
      },
      {
        ...
        bullets: [
          ...
          t(
            "wetSignature.tooltip.type.bullet2",
            "Customize text size and color",
          ),
          t(
            "wetSignature.tooltip.type.bullet3",
            "Perfect for standardized signatures",
          ),
        ],
      },
    ],
