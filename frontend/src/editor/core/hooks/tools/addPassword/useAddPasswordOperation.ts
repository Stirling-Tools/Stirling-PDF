...
import {
  ...
  defaultParameters,
} from "@editor/hooks/tools/addPassword/useAddPasswordParameters";
import { defaultParameters as permissionsDefaults } from "@editor/hooks/tools/changePermissions/useChangePermissionsParameters";
