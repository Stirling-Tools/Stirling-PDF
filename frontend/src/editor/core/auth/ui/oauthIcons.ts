 ...
 */
import googleIcon from "@editor/assets/login/google.svg";
import githubIcon from "@editor/assets/login/github.svg";
import appleIcon from "@editor/assets/login/apple.svg";
import microsoftIcon from "@editor/assets/login/microsoft.svg";
import keycloakIcon from "@editor/assets/login/keycloak.svg";
import cloudronIcon from "@editor/assets/login/cloudron.svg";
import authentikIcon from "@editor/assets/login/authentik.svg";
import oidcIcon from "@editor/assets/login/oidc.svg";
