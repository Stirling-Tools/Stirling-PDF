...
import { devApiLink } from "@editor/constants/links";
...
import { isSuperToolId, isLinkToolId } from "@editor/types/toolId";
import {
  asRegistryConfig,
  lazySettings,
} from "@editor/hooks/tools/shared/toolOperationTypes";
import { adjustContrastOperationConfig } from "@editor/hooks/tools/adjustContrast/useAdjustContrastOperation";
import { getSynonyms } from "@editor/utils/toolSynonyms";
import { useProprietaryToolRegistry } from "@editor/data/useProprietaryToolRegistry";
...
import { convertOperationConfig } from "@editor/hooks/tools/convert/useConvertOperation";
...
import { usePrototypeToolRegistry } from "@editor/data/usePrototypeToolRegistry";
...
import { autoRotateOperationConfig } from "@editor/hooks/tools/autoRotate/useAutoRotateOperation";
import { changeMetadataOperationConfig } from "@editor/hooks/tools/changeMetadata/useChangeMetadataOperation";
import { signOperationConfig } from "@editor/hooks/tools/sign/useSignOperation";
import { cropOperationConfig } from "@editor/hooks/tools/crop/useCropOperation";
import { removeAnnotationsOperationConfig } from "@editor/hooks/tools/removeAnnotations/useRemoveAnnotationsOperation";
...
import { extractPagesOperationConfig } from "@editor/hooks/tools/extractPages/useExtractPagesOperation";
import { ENDPOINTS as SPLIT_ENDPOINT_NAMES } from "@editor/constants/splitConstants";
import { ToolId } from "@editor/types/toolId";
import { CONVERT_SUPPORTED_FORMATS } from "@editor/constants/convertSupportedFornats";
  ...
  return useMemo(() => {
    const allTools: ToolRegistry = {
      ...
      pdfTextEditor: {
        ...
        component: lazy(
          () => import("@editor/tools/pdfTextEditor/PdfTextEditor"),
        ),
        description: t(
      ...
      merge: {
        ...
        component: lazy(() => import("@editor/tools/Merge")),
        description: t(
          "home.merge.desc",
        ...
        automationSettings: lazySettings(
          () => import("@editor/components/tools/merge/MergeSettings"),
        ),
      ...
      certSign: {
        ...
        component: lazy(() => import("@editor/tools/CertSign")),
        description: t(
          "home.certSign.desc",
        ...
        automationSettings: lazySettings(
          () =>
            import("@editor/components/tools/certSign/CertSignAutomationSettings"),
        ),
      },
      timestampPdf: {
        icon: (
        ...
        component: lazy(() => import("@editor/tools/TimestampPdf")),
        description: t(
      ...
      sign: {
        ...
        component: lazy(() => import("@editor/tools/Sign")),
        description: t(
          "home.sign.desc",
        ...
        automationSettings: lazySettings(
          () => import("@editor/components/tools/sign/SignSettings"),
      ...
      sharedSign: {
        ...
        component: lazy(() => import("@editor/tools/SharedSign")),
        description: t(
      ...
      addText: {
        ...
        component: lazy(() => import("@editor/tools/AddText")),
        description: t(
          "home.addText.desc",
      ...
      addImage: {
        ...
        component: lazy(() => import("@editor/tools/AddImage")),
      ...
      annotate: {
        ...
        component: lazy(() => import("@editor/tools/Annotate")),
        description: t(
          "home.annotate.desc",
      ...
      addPassword: {
        ...
        component: lazy(() => import("@editor/tools/AddPassword")),
        description: t(
        ...
        automationSettings: lazySettings(
          () =>
            import("@editor/components/tools/addPassword/AddPasswordSettings"),
        ),
      ...
      watermark: {
        ...
        component: lazy(() => import("@editor/tools/AddWatermark")),
        maxFiles: -1,
        description: t(
          "home.watermark.desc",
        ...
        automationSettings: lazySettings(
          () =>
            import("@editor/components/tools/addWatermark/AddWatermarkSingleStepSettings"),
        ),
      ...
      addStamp: {
        ...
        component: lazy(() => import("@editor/tools/AddStamp")),
        description: t(
          "home.addStamp.desc",
        ...
        automationSettings: lazySettings(
          () =>
            import("@editor/components/tools/addStamp/AddStampAutomationSettings"),
        ),
      },
      sanitize: {
        icon: (
        ...
        component: lazy(() => import("@editor/tools/Sanitize")),
        maxFiles: -1,
        categoryId: ToolCategoryId.STANDARD_TOOLS,
        subcategoryId: SubcategoryId.DOCUMENT_SECURITY,
        description: t(
        ...
        automationSettings: lazySettings(
          () => import("@editor/components/tools/sanitize/SanitizeSettings"),
        ),
      ...
      flatten: {
        ...
        component: lazy(() => import("@editor/tools/Flatten")),
        description: t(
          "home.flatten.desc",
        ...
        automationSettings: lazySettings(
          () => import("@editor/components/tools/flatten/FlattenSettings"),
        ),
      ...
      unlockPDFForms: {
        ...
        component: lazy(() => import("@editor/tools/UnlockPdfForms")),
        description: t(
      ...
      formFill: {
        ...
        component: lazy(() => import("@editor/tools/formFill/FormFill")),
        description: t(
          "home.formFill.desc",
      ...
      changePermissions: {
        ...
        component: lazy(() => import("@editor/tools/ChangePermissions")),
        description: t(
        ...
        automationSettings: lazySettings(
          () =>
            import("@editor/components/tools/changePermissions/ChangePermissionsSettings"),
        ),
      ...
      getPdfInfo: {
        ...
        component: lazy(() => import("@editor/tools/GetPdfInfo")),
        description: t(
      ...
      validateSignature: {
        ...
        component: lazy(() => import("@editor/tools/ValidateSignature")),
        description: t(
      ...
      changeMetadata: {
        ...
        component: lazy(() => import("@editor/tools/ChangeMetadata")),
        description: t(
        ...
        automationSettings: lazySettings(
          () =>
            import("@editor/components/tools/changeMetadata/ChangeMetadataSingleStep"),
        ),
      ...
      editTableOfContents: {
        ...
        component: lazy(() => import("@editor/tools/EditTableOfContents")),
        description: t(
      ...
      crop: {
        ...
        component: lazy(() => import("@editor/tools/Crop")),
        description: t(
          "home.crop.desc",
        ...
        automationSettings: lazySettings(
          () => import("@editor/components/tools/crop/CropAutomationSettings"),
        ),
      },
      rotate: {
        icon: (
        ...
        component: lazy(() => import("@editor/tools/Rotate")),
        ...
        automationSettings: lazySettings(
          () =>
            import("@editor/components/tools/rotate/RotateAutomationSettings"),
        ),
      ...
      autoRotate: {
        ...
        component: lazy(() => import("@editor/tools/AutoRotate")),
        description: t(
        ...
        automationSettings: lazySettings(
          () =>
            import("@editor/components/tools/autoRotate/AutoRotateAutomationSettings"),
        ),
      ...
      split: {
        ...
        component: lazy(() => import("@editor/tools/Split")),
        ...
        automationSettings: lazySettings(
          () =>
            import("@editor/components/tools/split/SplitAutomationSettings"),
        ),
      ...
      reorganizePages: {
        ...
        component: lazy(() => import("@editor/tools/ReorganizePages")),
        description: t(
      ...
      scalePages: {
        ...
        component: lazy(() => import("@editor/tools/AdjustPageScale")),
        description: t(
        ...
        automationSettings: lazySettings(
          () =>
            import("@editor/components/tools/adjustPageScale/AdjustPageScaleSettings"),
        ),
      ...
      addPageNumbers: {
        ...
        component: lazy(() => import("@editor/tools/AddPageNumbers")),
        description: t(
        ...
        automationSettings: lazySettings(
          () =>
            import("@editor/components/tools/addPageNumbers/AddPageNumbersAutomationSettings"),
        ),
        maxFiles: -1,
      ...
      pageLayout: {
        ...
        component: lazy(() => import("@editor/tools/PageLayout")),
        description: t(
        ...
        automationSettings: lazySettings(
          () =>
            import("@editor/components/tools/pageLayout/PageLayoutSettings"),
        ),
      ...
      bookletImposition: {
        ...
        component: lazy(() => import("@editor/tools/BookletImposition")),
        operationConfig: asRegistryConfig(bookletImpositionOperationConfig),
        automationSettings: lazySettings(
          () =>
            import("@editor/components/tools/bookletImposition/BookletImpositionSettings"),
        ),
        description: t(
      ...
      pdfToSinglePage: {
        ...
        component: lazy(() => import("@editor/tools/SingleLargePage")),
      ...
      addAttachments: {
        ...
        component: lazy(() => import("@editor/tools/AddAttachments")),
        description: t(
        ...
        automationSettings: lazySettings(
          () =>
            import("@editor/components/tools/addAttachments/AddAttachmentsSettings"),
        ),
      },
      ...
      extractPages: {
        ...
        component: lazy(() => import("@editor/tools/ExtractPages")),
        description: t(
        ...
        automationSettings: lazySettings(
          () =>
            import("@editor/components/tools/extractPages/ExtractPagesSettings"),
        ),
      ...
      extractImages: {
        ...
        component: lazy(() => import("@editor/tools/ExtractImages")),
        description: t(
        ...
        automationSettings: lazySettings(
          () =>
            import("@editor/components/tools/extractImages/ExtractImagesSettings"),
        ),
      ...
      removePages: {
        ...
        component: lazy(() => import("@editor/tools/RemovePages")),
        description: t(
        ...
        automationSettings: lazySettings(
          () =>
            import("@editor/components/tools/removePages/RemovePagesSettings"),
        ),
      },
      removeBlanks: {
        icon: (
        ...
        component: lazy(() => import("@editor/tools/RemoveBlanks")),
        description: t(
        ...
        automationSettings: lazySettings(
          () =>
            import("@editor/components/tools/removeBlanks/RemoveBlanksSettings"),
        ),
      },
      removeAnnotations: {
        icon: (
        ...
        component: lazy(() => import("@editor/tools/RemoveAnnotations")),
        description: t(
      ...
      removeImage: {
        ...
        component: lazy(() => import("@editor/tools/RemoveImage")),
        description: t(
      ...
      removePassword: {
        ...
        component: lazy(() => import("@editor/tools/RemovePassword")),
        description: t(
        ...
        automationSettings: lazySettings(
          () =>
            import("@editor/components/tools/removePassword/RemovePasswordSettings"),
        ),
      ...
      removeCertSign: {
        ...
        component: lazy(() => import("@editor/tools/RemoveCertificateSign")),
        description: t(
      ...
      automate: {
        ...
        component: lazy(() => import("@editor/tools/Automate")),
        description: t(
          "home.automate.desc",
      ...
      autoRename: {
        ...
        component: lazy(() => import("@editor/tools/AutoRename")),
        maxFiles: -1,
      ...
      adjustContrast: {
        ...
        component: lazy(() => import("@editor/tools/AdjustContrast")),
        description: t(
        ...
        automationSettings: lazySettings(
          () =>
            import("@editor/components/tools/adjustContrast/AdjustContrastSingleStepSettings"),
        ),
      ...
      repair: {
        ...
        component: lazy(() => import("@editor/tools/Repair")),
        description: t(
          "home.repair.desc",
      ...
      scannerImageSplit: {
        ...
        component: lazy(() => import("@editor/tools/ScannerImageSplit")),
        description: t(
        ...
        automationSettings: lazySettings(
          () =>
            import("@editor/components/tools/scannerImageSplit/ScannerImageSplitSettings"),
        ),
      ...
      overlayPdfs: {
        ...
        component: lazy(() => import("@editor/tools/OverlayPdfs")),
        description: t(
        ...
        automationSettings: lazySettings(
          () =>
            import("@editor/components/tools/overlayPdfs/OverlayPdfsSettings"),
        ),
      },
      replaceColor: {
        icon: (
        ...
        component: lazy(() => import("@editor/tools/ReplaceColor")),
        description: t(
        ...
        automationSettings: lazySettings(
          () =>
            import("@editor/components/tools/replaceColor/ReplaceColorSettings"),
        ),
      ...
      showJS: {
        ...
        component: lazy(() => import("@editor/tools/ShowJS")),
        description: t(
          "home.showJS.desc",
      ...
      compare: {
        ...
        component: lazy(() => import("@editor/tools/Compare")),
        description: t(
          "home.compare.desc",
      ...
      compress: {
        ...
        component: lazy(() => import("@editor/tools/Compress")),
        description: t(
          "home.compress.desc",
        ...
        automationSettings: lazySettings(
          () => import("@editor/components/tools/compress/CompressSettings"),
        ),
      ...
      convert: {
        ...
        component: lazy(() => import("@editor/tools/Convert")),
        description: t(
          "home.convert.desc",
        ...
        automationSettings: lazySettings(
          () => import("@editor/components/tools/convert/ConvertSettings"),
        ),
      ...
      ocr: {
        ...
        component: lazy(() => import("@editor/tools/OCR")),
        description: t(
          "home.ocr.desc",
        ...
        automationSettings: lazySettings(
          () => import("@editor/components/tools/ocr/OCRSettings"),
        ),
      ...
      redact: {
        ...
        component: lazy(() => import("@editor/tools/Redact")),
        description: t(
          "home.redact.desc",
        ...
        automationSettings: lazySettings(
          () =>
            import("@editor/components/tools/redact/RedactSingleStepSettings"),
        ),
