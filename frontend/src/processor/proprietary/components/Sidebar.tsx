...
import { AppSwitch } from "@editor/components/shared/AppSwitch";
import { useTranslation } from "react-i18next";
import { useNavigate } from "react-router-dom";
import { useView, type ViewId } from "@processor/contexts/ViewContext";
import { useTheme } from "@processor/contexts/ThemeContext";
...
import { SettingsIcon } from "@processor/components/icons";
import {
  GROUP_PROCESSOR,
  GROUP_PLATFORM,
  type NavEntry,
