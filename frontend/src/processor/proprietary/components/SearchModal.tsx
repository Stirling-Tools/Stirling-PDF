...
import { Button, EmptyState, Modal, Skeleton } from "@editor/ui";
import { useTranslation } from "react-i18next";
import { useUI } from "@processor/contexts/UIContext";
import { useAsync, useSectionFlags } from "@processor/hooks/useAsync";
import { fetchQuickActions, type QuickAction } from "@processor/api/search";
import { SearchIcon } from "@processor/components/icons";
import "@processor/components/SearchModal.css";
