...
import { DealJourney } from "@processor/components/procurement/DealJourney";
import { buildProcurement } from "@processor/mocks/procurement";
import type { Deal } from "@processor/api/procurement";
