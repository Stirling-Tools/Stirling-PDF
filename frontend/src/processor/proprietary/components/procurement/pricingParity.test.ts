...
import type { QuoteConfigInput } from "@processor/api/procurement";
import { previewAnnualMinor } from "@processor/components/procurement/QuoteBuilder";
import { priceQuote } from "@processor/mocks/handlers/procurementSaas";
