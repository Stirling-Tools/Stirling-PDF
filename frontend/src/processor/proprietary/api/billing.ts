...
import type { Wallet } from "@editor/billing";
 ...
 * itself lives in {@code @editor/billing} (shared with the editor cloud surface).
 */

// Re-export the shared contract so existing `@processor/api/billing` importers keep working.
export type {
  Wallet,
  WalletStatus,
  WalletRole,
