...
import { fromWirePolicy, toWirePolicy } from "@editor/policies/codec";
import { runsToActivity, runsToStats } from "@editor/policies/runs";
import { policyStep, type PolicyToolStep } from "@editor/policies/operations";
...
export type { WirePipelineStep as PipelineStep } from "@editor/policies/types";
...
export interface DecoratedPolicy {
  ...
  state: PolicyState;
  steps: WirePipelineStep[];
  stats: import("@editor/policies/types").PolicyStats;
  activity: import("@editor/policies/types").PolicyActivityItem[];
}
