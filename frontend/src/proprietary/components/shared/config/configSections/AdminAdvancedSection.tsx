      ...
      <Stack gap="lg" className="settings-section-content">
        ...
        <Paper withBorder p="md" radius="md">
          <Stack gap="md">
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <div>
                <Text fw={500} size="sm">
                  {t("admin.settings.advanced.enableAlphaFunctionality.label", "Enable Alpha Features")}
                </Text>
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <div>
                <Text fw={500} size="sm">
                  {t("admin.settings.advanced.enableUrlToPDF.label", "Enable URL to PDF")}
                </Text>
                <Text size="xs" c="dimmed" mt={4}>
                  {t(
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <div>
                <Text fw={500} size="sm">
                  {t("admin.settings.advanced.disableSanitize.label", "Disable HTML Sanitization")}
                </Text>
                <Text size="xs" c="dimmed" mt={4}>
                  {t(
        ...
        <Paper withBorder p="md" radius="md">
          <Stack gap="md">
            <div>
              <Text fw={600} size="sm" mb="xs">
                {t("admin.settings.advanced.tempFileManagement.label", "Temp File Management")}
              </Text>
              <Text size="xs" c="dimmed">
                {t(
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <div>
                <Text fw={500} size="sm">
                  {t("admin.settings.advanced.tempFileManagement.startupCleanup.label", "Startup Cleanup")}
                </Text>
                <Text size="xs" c="dimmed" mt={4}>
                  {t(
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <div>
                <Text fw={500} size="sm">
                  {t("admin.settings.advanced.tempFileManagement.cleanupSystemTemp.label", "Cleanup System Temp")}
                </Text>
                <Text size="xs" c="dimmed" mt={4}>
                  {t(
        ...
        <Paper withBorder p="md" radius="md">
          <Stack gap="md">
            <Text fw={600} size="sm">
              {t("admin.settings.advanced.processExecutor.label", "Process Executor Limits")}
            </Text>
            <Text size="xs" c="dimmed">
              {t(
            ...
            <Accordion variant="separated">
              ...
              <Accordion.Item value="libreOffice">
                <Accordion.Control>
                  {t("admin.settings.advanced.processExecutor.libreOffice", "LibreOffice")}
                </Accordion.Control>
                <Accordion.Panel>
                  <Stack gap="sm">
                    <NumberInput
              ...
              <Accordion.Item value="tesseract">
                <Accordion.Control>
                  {t("admin.settings.advanced.processExecutor.tesseract", "Tesseract OCR")}
                </Accordion.Control>
                <Accordion.Panel>
                  <Stack gap="sm">
                    <NumberInput
              ...
              <Accordion.Item value="pythonOpenCv">
                <Accordion.Control>
                  {t("admin.settings.advanced.processExecutor.pythonOpenCv", "Python OpenCV")}
                </Accordion.Control>
                <Accordion.Panel>
                  <Stack gap="sm">
                    <NumberInput
              ...
              <Accordion.Item value="ghostscript">
                <Accordion.Control>
                  {t("admin.settings.advanced.processExecutor.ghostscript", "Ghostscript")}
                </Accordion.Control>
                <Accordion.Panel>
                  <Stack gap="sm">
                    <NumberInput
