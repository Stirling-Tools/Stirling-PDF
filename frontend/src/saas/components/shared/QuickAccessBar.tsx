...
import { ActionIcon, Avatar, Divider, Indicator, Menu, Stack } from "@mantine/core";
        ...
        <div className="scrollable-content">
          ...
          <Stack gap="lg" align="center">
            {bottomButtons.map((buttonConfig, index) => {
              ...
              // Handle config button with profile picture
              if (buttonConfig.id === 'config' && profilePictureUrl) {
                const isActive = isNavButtonActive(buttonConfig, activeButton, isFilesModalOpen, configModalOpen, selectedToolKey, leftPanelView);
                const shouldShowSettingsBadge = licenseAlert.active && licenseAlert.audience === 'admin';
