...
const GROUP_PLATFORM: NavEntry[] = [
  { id: "infrastructure", label: "Infrastructure", icon: <InfrastructureIcon /> },
...
function StirlingMark() {
  ...
  return (
    ...
    >
      ...
      <path
        d="M5 11 L17 11 L14 18 L2 18 Z"
        fill="var(--color-blue-border)"
      />
    </svg>
  );
}
  ...
  return (
    <aside className="portal-sidebar" aria-label="Primary navigation">
      ...
      <nav className="portal-sidebar__nav">
        <div className="portal-sidebar__group">{renderGroup(GROUP_PRIMARY)}</div>
