...
test.describe('14. Fullscreen Mode', () => {
  ...
  test.describe('14.1 Toggle Fullscreen Tool Picker', () => {
    test('should toggle fullscreen mode for tool picker', async ({ page }) => {
      ...
      const fullscreenButton = page.getByRole('button', { name: /fullscreen|layar penuh/i }).first();
      ...
      const exitButton = page.getByRole('button', { name: /fullscreen|layar penuh|sidebar|bilah sisi/i }).first();
