...
const AccountSection: React.FC = () => {
  ...
  const handleLogout = useCallback(async () => {
    try {
      ...
      // Desktop-specific: mirror the Connection Settings logout flow to avoid stale config and bad login screens
      ...
      console.warn('[Desktop AccountSection] Logout fallback failed, redirecting to login', desktopErr);
    }
