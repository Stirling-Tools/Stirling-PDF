  ...
  return (
    <Card padding="loose">
      <span className="portal-proc__eyebrow">
        {t("procurement.agreement.eyebrow")}
      </span>
      <h3 className="portal-proc__builder-title">
        {t("procurement.agreement.title")}
      </h3>
      <p className="portal-proc__subtitle">
        {t("procurement.agreement.intro")}
      </p>
      ...
      <label className="portal-qb__eula portal-agreement__accept">
        ...
        />
        <span>{t("procurement.agreement.confirm")}</span>
      </label>
      ...
      <div className="portal-proc__payment-actions">
        <Button
          ...
          onClick={onAgree}
        >
          {t("procurement.agreement.agreeCta")}
        </Button>
      </div>
    </Card>
  );
