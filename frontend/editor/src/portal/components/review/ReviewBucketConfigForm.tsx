...
export function ReviewBucketConfigForm() {
  ...
  useEffect(() => {
    ...
    // defaults it hides — otherwise active rules would be invisible.
    if (
      ...
      >
        <div className="review-config__section-head">
          <h4 className="review-config__heading">
            {t("portal.review.config.categories.heading", "Watched categories")}
          </h4>
          <span className="review-config__tally">
            {watchedTotal === 0
              ? t("portal.review.config.categories.none", "Nothing watched yet")
                      ...
                      <span className="review-config__family-lead">
                        <ExpandMoreRoundedIcon
                          className={
                            ...
                            (expanded ? " review-config__chevron--open" : "")
                          }
                        />
                        <LocalIcon
                          icon={family.icon}
                    ...
                    rightSection={
                      <span className="review-config__family-count">
                        {selected === 0
                          ...
                          : selected === total
                            ? t("portal.review.config.family.all", "All types")
          ...
          <div className="review-config__advanced">
            ...
            <SettingsRow
              label={t(
                ...
                "Hold low-confidence classifications",
              )}
              description={t(
                "portal.review.config.holdLowConfidence.description",
                "Hold documents the AI could not classify confidently.",
              )}
              control={
                <ToggleSwitch
                  size="sm"
