 ...
 *
 * Free teams only, matching the editor and the Plan page. A paying team's
 * headline number is spend against its cap, not what's left of the grant, so a
 * draining free meter next to a live invoice would read as a problem when
 * nothing is wrong; their usage lives on Usage & Billing.
 */
