...
export function useConnectGate(): ConnectGate {
  // Optional so this is safe from shared chrome: the SaaS portal mounts no LinkProvider because
  // the signed-in account IS the SaaS account, and no provider means nothing to gate.
