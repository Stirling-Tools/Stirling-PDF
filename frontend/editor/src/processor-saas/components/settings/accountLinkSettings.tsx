import type { AccountLinkSettingsSeam } from "@processor-proprietary/components/settings/accountLinkSettings";
 ...
 * modal (the processor host treats the seam as optional), so the link-only
