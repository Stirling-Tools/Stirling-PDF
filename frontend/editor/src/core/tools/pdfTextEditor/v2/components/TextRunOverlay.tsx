...
export function TextRunOverlay({
  ...
  // PDFium-reported bounds.height only captures the visible glyph extent
  // (often x-height for lowercase-heavy runs, not cap+descender), so a
  // line of body text frequently reports height=3pt for a 12pt font.
  ...
  // the user sees in the bitmap. Falls back to bounds.height when the
  // model already reports a sensible value (multi-line paragraphs).
