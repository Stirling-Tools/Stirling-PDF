...
import {
  ...
  rulerTicks,
  snapToGuides,
} from "@app/tools/pdfTextEditor/util/guides";
import type {
  Guide,
  GuideAxis,
  GuideOrientation,
...
export function PageRulers({
  ...
  const unit = t("pdfTextEditor.rulers.unit", "pt");
  ...
  return (
    <div
      ref={rootRef}
      data-testid={`pdf-editor-rulers-${pageIndex}`}
      style={{
        position: "absolute",
        top: 0,
        left: 0,
    ...
    >
      ...
      <RulerBand
        ...
        marks={topBand.marks}
        cssLength={cssWidth}
        label={t("pdfTextEditor.rulers.horizontal", "Horizontal ruler")}
      ...
      <RulerBand
        ...
        cssLength={cssHeight}
        label={t("pdfTextEditor.rulers.vertical", "Vertical ruler")}
      ...
      {guides.map((guide) => {
        ...
        return (
          <div
            ...
            aria-label={label}
            title={label}
            data-testid={`pdf-editor-guide-${guide.id}`}
...
function RulerBand({
  ...
  return (
    <div
      ...
      aria-label={label}
      title={label}
      data-testid={`pdf-editor-ruler-${edge}-${pageIndex}`}
