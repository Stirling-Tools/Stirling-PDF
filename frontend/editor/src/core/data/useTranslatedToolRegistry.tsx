...
import { asRegistryConfig, lazySettings } from "@app/hooks/tools/shared/toolOperationTypes";
  ...
  return useMemo(() => {
    const allTools: ToolRegistry = {
      ...
      merge: {
        ...
        automationSettings: lazySettings(() => import("@app/components/tools/merge/MergeSettings")),
      ...
      certSign: {
        ...
        automationSettings: lazySettings(() => import("@app/components/tools/certSign/CertSignAutomationSettings")),
      },
      timestampPdf: {
      ...
      sign: {
        ...
        automationSettings: lazySettings(() => import("@app/components/tools/sign/SignSettings")), // TODO:: not all settings shown, suggested next tools shown
      ...
      sharedSign: {
        ...
        description: t("home.sharedSign.desc", "Request signatures from others and track signing sessions"),
        categoryId: ToolCategoryId.STANDARD_TOOLS,
        subcategoryId: SubcategoryId.SIGNING,
        automationSettings: null,
        supportsAutomate: false,
      ...
      addPassword: {
        ...
        automationSettings: lazySettings(() => import("@app/components/tools/addPassword/AddPasswordSettings")),
      ...
      watermark: {
        ...
        automationSettings: lazySettings(() => import("@app/components/tools/addWatermark/AddWatermarkSingleStepSettings")),
      ...
      addStamp: {
        ...
        automationSettings: lazySettings(() => import("@app/components/tools/addStamp/AddStampAutomationSettings")),
      },
      sanitize: {
        ...
        automationSettings: lazySettings(() => import("@app/components/tools/sanitize/SanitizeSettings")),
      ...
      flatten: {
        ...
        automationSettings: lazySettings(() => import("@app/components/tools/flatten/FlattenSettings")),
      ...
      formFill: {
        ...
        description: t("home.formFill.desc", "Fill, create, edit, and delete PDF form fields with a visual editor"),
        categoryId: ToolCategoryId.STANDARD_TOOLS,
        subcategoryId: SubcategoryId.GENERAL,
        ...
        automationSettings: null,
        supportsAutomate: false,
        synonyms: ["form", "fill", "fillable", "input", "field", "acroform", "edit", "create", "editor", "modify", "builder"],
      },
      changePermissions: {
        ...
        automationSettings: lazySettings(() => import("@app/components/tools/changePermissions/ChangePermissionsSettings")),
      ...
      changeMetadata: {
        ...
        automationSettings: lazySettings(() => import("@app/components/tools/changeMetadata/ChangeMetadataSingleStep")),
      ...
      crop: {
        ...
        automationSettings: lazySettings(() => import("@app/components/tools/crop/CropAutomationSettings")),
      },
      rotate: {
        ...
        automationSettings: lazySettings(() => import("@app/components/tools/rotate/RotateAutomationSettings")),
        synonyms: getSynonyms(t, "rotate"),
      },
      autoRotate: {
        icon: <LocalIcon icon="screen-rotation-alt-rounded" width="1.5rem" height="1.5rem" />,
        name: t("home.autoRotate.title", "Auto Rotate"),
        component: lazy(() => import("@app/tools/AutoRotate")),
        description: t("home.autoRotate.desc", "Detect each page's orientation and rotate it upright automatically."),
        categoryId: ToolCategoryId.STANDARD_TOOLS,
        subcategoryId: SubcategoryId.PAGE_FORMATTING,
        maxFiles: -1,
        endpoints: ["auto-rotate-pdf"],
        operationConfig: asRegistryConfig(autoRotateOperationConfig),
        automationSettings: lazySettings(() => import("@app/components/tools/autoRotate/AutoRotateAutomationSettings")),
      ...
      split: {
        ...
        automationSettings: lazySettings(() => import("@app/components/tools/split/SplitAutomationSettings")),
      ...
      reorganizePages: {
        ...
        automationSettings: lazySettings(() => import("@app/components/tools/reorganizePages/ReorganizePagesSettings")),
      },
      scalePages: {
        ...
        automationSettings: lazySettings(() => import("@app/components/tools/adjustPageScale/AdjustPageScaleSettings")),
      ...
      pageLayout: {
        ...
        automationSettings: lazySettings(() => import("@app/components/tools/pageLayout/PageLayoutSettings")),
      ...
      bookletImposition: {
        ...
        automationSettings: lazySettings(() => import("@app/components/tools/bookletImposition/BookletImpositionSettings")),
        description: t(
      ...
      addAttachments: {
        ...
        description: t("home.addAttachments.desc", "View, add, extract, rename, or delete embedded PDF attachments"),
        categoryId: ToolCategoryId.STANDARD_TOOLS,
        subcategoryId: SubcategoryId.PAGE_FORMATTING,
        synonyms: getSynonyms(t, "addAttachments"),
        maxFiles: 1,
        endpoints: ["add-attachments", "batch-process-attachments", "list-attachments"],
        operationConfig: asRegistryConfig(addAttachmentsOperationConfig),
        automationSettings: lazySettings(() => import("@app/components/tools/addAttachments/AddAttachmentsSettings")),
      },
      ...
      extractPages: {
        ...
        automationSettings: lazySettings(() => import("@app/components/tools/extractPages/ExtractPagesSettings")),
      ...
      extractImages: {
        ...
        automationSettings: lazySettings(() => import("@app/components/tools/extractImages/ExtractImagesSettings")),
      ...
      removePages: {
        ...
        automationSettings: lazySettings(() => import("@app/components/tools/removePages/RemovePagesSettings")),
      },
      removeBlanks: {
        ...
        automationSettings: lazySettings(() => import("@app/components/tools/removeBlanks/RemoveBlanksSettings")),
      },
      removeAnnotations: {
      ...
      removePassword: {
        ...
        automationSettings: lazySettings(() => import("@app/components/tools/removePassword/RemovePasswordSettings")),
      ...
      scannerImageSplit: {
        ...
        automationSettings: lazySettings(() => import("@app/components/tools/scannerImageSplit/ScannerImageSplitSettings")),
      ...
      overlayPdfs: {
        ...
        automationSettings: lazySettings(() => import("@app/components/tools/overlayPdfs/OverlayPdfsSettings")),
      },
      replaceColor: {
        ...
        automationSettings: lazySettings(() => import("@app/components/tools/replaceColor/ReplaceColorSettings")),
      ...
      classify: {
        icon: <LocalIcon icon="label-outline-rounded" width="1.5rem" height="1.5rem" />,
        name: t("home.classify.title", "Classify"),
        // No interactive UI: this is a pipeline step, registered so a pipeline can name it.
        component: null,
        description: t("home.classify.desc", "Identify what kind of document this is and tag it."),
        categoryId: ToolCategoryId.ADVANCED_TOOLS,
      ...
      compress: {
        ...
        automationSettings: lazySettings(() => import("@app/components/tools/compress/CompressSettings")),
      ...
      convert: {
        ...
        automationSettings: lazySettings(() => import("@app/components/tools/convert/ConvertSettings")),
      ...
      ocr: {
        ...
        automationSettings: lazySettings(() => import("@app/components/tools/ocr/OCRSettings")),
      ...
      redact: {
        ...
        automationSettings: lazySettings(() => import("@app/components/tools/redact/RedactSingleStepSettings")),
