...
export const FROM_FORMAT_OPTIONS = [
  ...
  { value: "heic", label: "HEIC", group: "Image" },
  { value: "heif", label: "HEIF", group: "Image" },
  { value: "avif", label: "AVIF", group: "Image" },
  { value: "jxl", label: "JXL", group: "Image" },
  { value: "jp2", label: "JP2", group: "Image" },
