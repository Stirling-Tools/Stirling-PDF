  ...
  return {
    ...
    tips: [
      ...
      },
      {
        ...
        description: t(
          "ocr.tooltip.advanced.deskew.text",
          "Automatically corrects skewed or tilted pages to improve OCR accuracy. Useful for scanned documents that weren't perfectly aligned.",
        ),
      },
      {
        title: t("ocr.tooltip.advanced.clean.title", "Clean Input File"),
        description: t(
          "ocr.tooltip.advanced.clean.text",
          "Preprocesses the input by removing noise, enhancing contrast, and optimising the image for better OCR recognition before processing.",
        ),
      },
      {
        title: t("ocr.tooltip.advanced.cleanFinal.title", "Clean Final Output"),
        description: t(
          "ocr.tooltip.advanced.cleanFinal.text",
          "Post-processes the final PDF by removing OCR artefacts and optimising the text layer for better readability and smaller file size.",
        ),
      },
    ],
  };
