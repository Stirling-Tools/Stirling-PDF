    ...
    tips: [
      ...
      },
      {
        ...
        description: t(
          ...
          "This alpha viewer is still in development. Some fonts, colors, transparency effects and layout details may shift slightly. Check the generated PDF before sharing.",
        ),
      },
    ],
  };
