...
const ProcessorIntroBody = () => (
  <span>
    <Trans
      ...
      defaults="Stirling now runs <strong>Policies</strong>: automated rules that classify, secure and process documents as they arrive. Set them up and monitor runs in the <strong>Processor</strong>."
    />
  </span>
);
