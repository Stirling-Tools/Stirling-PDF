...
export function LocalEmbedPDF({
  ...
  // Bumped to remount PdfEngineBoundary and re-run the WASM engine load after a
  // failed or hung initialisation (the user pressing "Retry").
    ...
    <PrivateContent>
      ...
      >
        <PdfEngineBoundary
          ...
          onRetry={() => setEngineAttempt((n) => n + 1)}
        >
          {(engine) => (
            <EmbedPDF
              engine={engine}
