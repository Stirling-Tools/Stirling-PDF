 ...
 * {@code create-payg-bundle-checkout} edge function, routed through Tauri
 * (explicit bearer, deep-link callback). The capacity + price live on the
 * server-issued quote ticket ({@code quote_id}); only its id crosses the wire.
 */
