...
import "@processor/components/shared/FlowModal.css";

/**
 * The one dialog shell for the processor's flows — procurement's takeover, the trial/licence/schedule
 * dialogs, the legal reader.
 *
 * A thin wrapper over the shared {@link Modal}, which already owns the processor, focus trap, scroll
...
export function FlowModal({
  ...
  return (
    <Modal
      ...
      ariaLabel={label}
      width={size}
      className={`processor-flowmodal processor-flowmodal--${size}`}
      title={header}
      footer={footer}
    >
      {children}
