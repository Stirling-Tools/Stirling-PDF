...
// so we render the same asset the processor nav uses rather than styled text. Theme-switched in CSS.
        ...
        {brand ? (
          <div className="processor-stepmodal__brand">
            <img
              src={wordmarkLight}
              alt="Stirling"
              className="processor-stepmodal__wordmark wordmark-light-only"
            />
            <img
              src={wordmarkDark}
              alt=""
