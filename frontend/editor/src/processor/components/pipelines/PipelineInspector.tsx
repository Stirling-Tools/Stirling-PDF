...
import "@processor/components/pipelines/PipelineInspector.css";
...
export function PipelineInspector({
  ...
  if (message) {
    return (
      <aside className="processor-surface processor-inspector">
        <EmptyState
          size="compact"
          title={message}
          description={t("processor.pipelines.inspector.multipleBody")}
        />
      </aside>
    );
  }
  ...
  if (!children) {
    return (
      <aside className="processor-surface processor-inspector">
        <EmptyState
          size="compact"
          title={t("processor.pipelines.inspector.noSelectionTitle")}
          description={t("processor.pipelines.inspector.noSelectionBody")}
        />
      </aside>
    );
  }
  ...
  return (
    <aside className="processor-surface processor-inspector">
      ...
      <div className="processor-inspector__title">
        {icon ?? <TuneRoundedIcon style={{ fontSize: "1.125rem" }} />}
        <span>{title}</span>
      </div>
      <div className="processor-inspector__body">
