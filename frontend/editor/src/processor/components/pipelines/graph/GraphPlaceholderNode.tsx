...
import "@processor/components/pipelines/graph/GraphPlaceholderNode.css";
...
export function GraphPlaceholderNode({
  ...
  return (
    <Button
      variant="quiet"
      className="processor-graph-placeholder"
      onClick={onAdd}
      leftSection={<AddRoundedIcon style={{ fontSize: "1.125rem" }} />}
    >
      <span className="processor-graph-placeholder__title">{label}</span>
    </Button>
  );
}
