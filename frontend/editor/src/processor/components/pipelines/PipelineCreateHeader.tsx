...
export function PipelineCreateHeader({
  ...
  return (
    <section className="processor-pipeline-create-header">
      <ActionIcon
        variant="quiet"
        size="sm"
        onClick={onBack}
        aria-label={t("processor.pipelines.builder.back")}
      >
      ...
      <Input
        ...
        value={name}
        placeholder={t("processor.pipelines.composer.namePlaceholder")}
        aria-label={t("processor.pipelines.composer.name")}
      ...
      <div className="processor-pipeline-create-header__actions">
        ...
        <PipelineBlockerTooltip
          heading={t("processor.pipelines.builder.blocker.heading")}
          blockers={
            readOnly && !permissionsLoading
              ? [t("processor.pipelines.builder.blocker.managerOnly")]
              : blockers
          }
        >
          <div className="processor-pipeline-create-header__create">
            <Button
              variant="secondary"
              size="sm"
            ...
            >
              {t("processor.pipelines.composer.createPaused")}
            </Button>
            <Button
              size="sm"
              ...
              onClick={onCreate}
            >
              {t("processor.pipelines.composer.create")}
            </Button>
          </div>
        </PipelineBlockerTooltip>
      </div>
