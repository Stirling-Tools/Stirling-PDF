...
export function LinkAccountModal({
  ...
  return (
    <Modal
      ...
      title={
        reauth
          ? t("processor.accountLink.modal.reauthTitle", "Sign in again")
          : t(
      ...
      {isSaasSupabaseConfigured ? (
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
          ...
          {import.meta.env.DEV && (
            ...
            >
              {t(
                "processor.accountLink.modal.simulateSignIn",
