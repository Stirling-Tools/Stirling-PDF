...
import type { FailureActionOffer } from "@processor/api/fileRunEvents";
...
const meta: Meta<typeof FailureActionButtons> = {
  title: "Processor/Failures/FailureActionButtons",
    ...
    event: {
      ...
      actions: [
        ...OPEN_EVENT.actions,
        {
          ...
          labelKey: "processor.failures.action.remediateAndRetry",
          enabled: true,
