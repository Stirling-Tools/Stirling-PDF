...
import type { Member } from "@processor/api/users";
...
const meta: Meta<typeof UsersDirectory> = {
  title: "Processor/Users/UsersDirectory",
  ...
  args: {
    members: MEMBERS.map((m) =>
      m.teamId === 2 && m.role === "member"
        ? {
            ...m,
            processorAccess: "team" as const,
            processorGrantId: undefined,
          }
        : m,
    ),
