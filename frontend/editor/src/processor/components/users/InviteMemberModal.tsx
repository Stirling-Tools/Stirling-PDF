...
import { createGrant } from "@processor/api/access";
...
interface InviteMemberModalProps {
  ...
  adminRole?: boolean;
  /** Whether processor-access grants can be created (ADMIN-only). Gates the Processor option. */
...
export function InviteMemberModal({
  ...
  return (
    <Modal
      ...
      footer={
        <div className="processor-users__modal-footer">
    ...
    >
      <div className="processor-users__invite-body">
        ...
        <div className="processor-users__invite-grid">
        ...
        {mode === "direct" && (
          <div className="processor-users__invite-access">
            <Checkbox
              checked={forceChange}
        ...
        <div className="processor-users__invite-access">
          <span className="processor-users__invite-access-label">
