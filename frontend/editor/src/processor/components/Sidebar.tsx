...
export function Sidebar() {
  ...
  // Editor and processor are one SPA when the editor serves this origin's root, so
  ...
  return (
    ...
    >
      <div className="processor-sidebar__logo">
        <BrandSwitcher
          current="processor"
          onSwitch={goToEditor}
          collapsed={collapsed}
        ...
        <ActionIcon
          variant="tertiary"
          className="processor-sidebar__collapse"
          aria-label={
            collapsed
