...
import { ProcurementAgreement } from "@processor/components/procurement/ProcurementAgreement";
import {
  DocumentsModal,
  LicenseModal,
  ScheduleCallModal,
  ...
  return (
    <>
      <ProcurementModal
        ...
        title={t("processor.procurement.title")}
        subtitle={t("processor.procurement.subtitle")}
      ...
      >
        ...
        {!isLinked && (
          <EmptyState
            eyebrow={t("processor.procurement.link.eyebrow")}
            title={t("processor.procurement.link.title")}
            description={t("processor.procurement.link.description")}
            actions={
              <Button variant="primary" onClick={() => openLinkModal()}>
                {t("processor.procurement.link.cta")}
              </Button>
            }
          />
        )}
