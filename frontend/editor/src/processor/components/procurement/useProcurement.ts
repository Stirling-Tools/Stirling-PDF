...
export function useProcurement(): ProcurementController {
  ...
  const isLinked = useProcessorLinked();
  ...
  async function onDownloadPdf() {
    ...
    try {
      ...
      setError(t("processor.procurement.milestone.downloadError"));
    } finally {
  ...
  async function onDownloadOfflineLicense() {
    ...
    try {
      ...
      setError(t("processor.procurement.license.downloadError"));
    } finally {
  ...
  async function onDownloadSignedAgreement() {
    ...
    try {
      ...
      setError(t("processor.procurement.agreement.downloadError"));
    } finally {
