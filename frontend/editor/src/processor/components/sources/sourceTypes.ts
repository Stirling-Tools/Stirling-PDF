...
function networkSourceFields(connectionTypeId: string): SourceFieldDef[] {
  return [
    ...
    },
    {
      ...
      helperTextKey: "processor.sources.processingModeHelp",
      advanced: true,
      options: [
        {
          value: "consume",
        ...
        {
          value: "track",
          labelKey: "processor.sources.networkFields.mode.options.track",
        },
        {
          value: "snapshot",
      ...
      },
      {
        ...
        options: [
          ...
          },
          {
            value: "track",
            labelKey:
              "processor.sources.types.folder.fields.mode.options.track",
          },
          {
            value: "snapshot",
            labelKey:
    ...
    fields: [
      ...
      },
      {
        ...
        options: [
          ...
          {
            value: "track",
            labelKey: "processor.sources.types.s3.fields.mode.options.track",
          },
          {
            value: "snapshot",
