...
export function ElevationBanner({
  ...
  if (secondsLeft !== null) {
    return (
      <Banner
        ...
        title={t("processor.documents.elevation.active.title", {
          time: formatCountdown(secondsLeft),
        })}
        description={
          fourEyes
            ? t("processor.documents.elevation.active.descriptionFourEyes")
            : t("processor.documents.elevation.active.description")
        }
      />
    );
  }
  ...
  return (
    <Banner
      ...
      title={t("processor.documents.elevation.gated.title")}
      description={
        fourEyes
          ? t("processor.documents.elevation.gated.descriptionFourEyes")
          : t("processor.documents.elevation.gated.description")
      }
      action={
        <Button size="sm" onClick={onRequest}>
          {t("processor.documents.elevation.requestAccess")}
        </Button>
      }
    />
  );
