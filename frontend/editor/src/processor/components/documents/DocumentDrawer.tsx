...
export function DocumentDrawer({ doc, onClose }: DocumentDrawerProps) {
  ...
  const subTabs: TabItem<SubTab>[] = [
    { key: "overview", label: t("processor.documents.drawer.tabs.overview") },
    {
      key: "extractions",
      label: t("processor.documents.drawer.tabs.extractions"),
    },
    { key: "audit", label: t("processor.documents.drawer.tabs.audit") },
  ];
  ...
  return (
    ...
    >
      <div className="processor-documents__drawer">
        <div className="processor-documents__drawer-status">
        ...
        <Tabs<SubTab>
          ...
          onChange={setTab}
          variant="underline"
          ariaLabel={t("processor.documents.drawer.sectionsAriaLabel")}
        />

        <div className="processor-documents__drawer-panel">
