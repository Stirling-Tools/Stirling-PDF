 ...
 * the price of 10". Three steps inside the shared processor {@link Modal}:
 *
...
export function BundleCheckoutModal({
    ...
    phase === "calc" ? (
      <div className="processor-billing__checkout-cap-actions">
        <Button variant="quiet" disabled={pdfBusy} onClick={onClose}>
          {t("processor.billing.prepaid.buy.cancel", "Cancel")}
        </Button>
        <Button
        ...
        >
          {t(
            "processor.billing.prepaid.buy.continueToPayment",
            "Continue to payment",
          )}
        </Button>
      </div>
      ...
      <div className="processor-billing__checkout-cap-actions">
        ...
        >
          {t("processor.billing.prepaid.buy.cancelPurchase", "Cancel purchase")}
        </Button>
        <Button disabled={busy || pdfBusy} onClick={payOnline}>
          {t("processor.billing.prepaid.pay.payOnline", "Pay online")}
        </Button>
      </div>
    ) : (
      ...
      <div className="processor-billing__checkout-cap-actions">
        ...
        >
          {t("processor.billing.prepaid.buy.back", "Back")}
        </Button>
        <Button
          disabled={!canAccept || busy || pdfBusy}
          onClick={handleFinalise}
        >
          {t("processor.billing.prepaid.buy.finalise", "Finalise")}
        </Button>
      </div>
    );
  ...
  return (
    <Modal
      ...
      onClose={onClose}
      width="md"
      className="processor-billing__bundle-modal processor-billing__checkout-modal--framed"
      ariaLabel={t(
    ...
    >
      <PrepayModalHeader
        ...
        title={
          resolving
            ? t(
                "processor.billing.prepaid.buy.loadingTitle",
                "Loading your quote",
              )
            : phase === "pay"
              ? t("processor.billing.prepaid.buy.payTitle", "Pay for your year")
              : t(
                  "processor.billing.prepaid.buy.calcTitle",
      ...
      <div className="processor-billing__checkout-scroll">
        {resolving && (
          <div className="processor-billing__bundle-pay" aria-busy="true">
...
function QuoteReceipt({
  ...
  const { t } = useTranslation();
  return (
    <div className="processor-billing__bundle-receipt">
      <div className="processor-billing__bundle-receipt-row processor-billing__bundle-receipt-row--head">
        <span>
          {t("processor.billing.prepaid.calc.handlesLabel", "Your Processor")}
        </span>
        <strong>
          {t(
            "processor.billing.prepaid.calc.handlesValue",
      ...
      {quote.priceMinor != null ? (
        <>
          <div className="processor-billing__bundle-receipt-row">
            <span>
              {t(
                "processor.billing.prepaid.calc.priceLabel",
                "Your year · 12 months for the price of 10",
              )}
            </span>
            <strong className="processor-billing__bundle-receipt-price">
              {formatMinor(quote.priceMinor, currency)}
            </strong>
          </div>
          {quote.savingsMinor != null && quote.savingsMinor > 0 && (
            <p className="processor-billing__bundle-savings">
              {t(
                "processor.billing.prepaid.calc.savings",
        ...
        <p className="processor-billing__bundle-savings">
          {t(
            "processor.billing.prepaid.calc.rateUnknown",
            "We'll show the exact price at checkout.",
          )}
        </p>
      )}
      {quote.poolCredits > 0 && (
        <p className="processor-billing__bundle-pool">
          {t(
            "processor.billing.prepaid.calc.poolCaption",
      ...
      {quote.poolCredits > 0 && (
        <div
          ...
          className="processor-billing__bundle-download"
          onClick={onDownload}
          onKeyDown={(e) => {
        ...
        >
          ...
          {downloading
            ? t("processor.billing.prepaid.review.downloading", "Preparing…")
            : t(
                "processor.billing.prepaid.review.download",
                "Download quote (PDF)",
              )}
          {!downloading && (
            <span className="processor-billing__bundle-download-share">
              ·{" "}
              {t(
                "processor.billing.prepaid.review.share",
                "share for approval",
              )}
            </span>
          )}
...
function CalculatorStep({
  ...
  const deployCards: PickerCard[] = [
    {
      id: "cloud",
      title: t("processor.billing.prepaid.deploy.cloud", "Stirling Cloud"),
      desc: t(
        "processor.billing.prepaid.deploy.cloudDesc",
        "Managed by Stirling. Live in minutes.",
      ),
    },
    {
      id: "selfhost",
      title: t("processor.billing.prepaid.deploy.selfhost", "Self-hosted"),
      desc: t(
        "processor.billing.prepaid.deploy.selfhostDesc",
  ...
  const sizeCards: PickerCard[] = [
    {
      id: "compact",
      title: t("processor.billing.prepaid.size.compact", "Compact"),
      meta: "×1",
      desc: t(
        "processor.billing.prepaid.size.compactDesc",
        "Files under 25 MB, no data charges",
      ),
    },
    {
      id: "standard",
      title: t("processor.billing.prepaid.size.standard", "Standard"),
      meta: "×1.2",
      desc: t(
        "processor.billing.prepaid.size.standardDesc",
        "Mostly small, some scans past 25 MB",
      ),
    },
    {
      id: "heavy",
      title: t("processor.billing.prepaid.size.heavy", "Heavy"),
      meta: "×2",
      desc: t(
        "processor.billing.prepaid.size.heavyDesc",
  ...
  const postureCards: PickerCard[] = [
    {
      id: "essentials",
      title: t("processor.billing.prepaid.posture.essentials", "Essentials"),
      meta: t(
        "processor.billing.prepaid.calc.policiesMeta",
        "{{count}} policies",
        {
          count: 2,
        },
      ...
      desc: t(
        "processor.billing.prepaid.posture.essentialsDesc",
        "Classification, the default, plus Sharing",
      ),
    },
    {
      id: "governed",
      title: t("processor.billing.prepaid.posture.governed", "Governed"),
      meta: t(
        "processor.billing.prepaid.calc.policiesMeta",
        "{{count}} policies",
        {
      ...
      desc: t(
        "processor.billing.prepaid.posture.governedDesc",
        "Adds Security and Routing",
      ),
    },
    {
      id: "regulated",
      title: t("processor.billing.prepaid.posture.regulated", "Regulated"),
      meta: t(
        "processor.billing.prepaid.calc.policiesMeta",
        "{{count}} policies",
        {
      ...
      desc: t(
        "processor.billing.prepaid.posture.regulatedDesc",
  ...
  const pipelineCards: PickerCard[] = [
    {
      id: "none",
      title: t("processor.billing.prepaid.pipelines.none", "None"),
      desc: t(
        "processor.billing.prepaid.pipelines.noneDesc",
        "Not running pipelines yet. Turn them on any time.",
      ),
    },
    {
      id: "standard",
      title: t("processor.billing.prepaid.pipelines.standard", "Standard"),
      desc: t(
        "processor.billing.prepaid.pipelines.standardDesc",
        "A few pipelines re-process arriving PDFs.",
      ),
    },
    {
      id: "advanced",
      title: t("processor.billing.prepaid.pipelines.advanced", "Advanced"),
      desc: t(
        "processor.billing.prepaid.pipelines.advancedDesc",
  ...
  const deployValue =
    deployId === "cloud"
      ? t(
          "processor.billing.prepaid.deploy.cloudValue",
          "Stirling Cloud · Managed",
        )
      : t(
          "processor.billing.prepaid.deploy.selfhostValue",
          "Self-hosted · Private infrastructure",
        );
  const sizeValue = t(
    "processor.billing.prepaid.calc.sizingValue",
    "{{label}} · {{desc}}",
    { label: size.title, desc: size.desc },
  );
  const postureValue = t(
    "processor.billing.prepaid.calc.governanceValue",
  ...
  const rows = [
    {
      id: "deploy",
      label: t("processor.billing.prepaid.calc.deployRow", "Deployment"),
      value: deployValue,
      cards: deployCards,
      activeId: deployId,
      onPick: setDeployId,
    ...
    {
      id: "size",
      label: t("processor.billing.prepaid.calc.sizingRow", "Sizing"),
      value: sizeValue,
      cards: sizeCards,
      activeId: sizeId,
      onPick: setSizeId,
    ...
    {
      id: "posture",
      label: t("processor.billing.prepaid.calc.governanceRow", "Governance"),
      value: postureValue,
      cards: postureCards,
      activeId: postureId,
      onPick: setPostureId,
    ...
    {
      id: "pipes",
      label: t("processor.billing.prepaid.calc.pipelinesLabel", "Pipelines"),
  ...
  return (
    <div className="processor-billing__bundle-calc">
      {actionError && (
        <Banner
          tone="danger"
          title={t(
            "processor.billing.prepaid.buy.invoiceErrorTitle",
      ...
      <div className="processor-billing__bundle-field">
        <div className="processor-billing__bundle-field-label">
          {t("processor.billing.prepaid.calc.usersLabel", "Total users")}
        </div>
        <div className="processor-billing__bundle-users">
          <NumberInput
            value={users}
            ...
            allowNegative={false}
            aria-label={t(
              "processor.billing.prepaid.calc.usersLabel",
              "Total users",
            )}
          />
        </div>
      ...
      <div className="processor-surface processor-billing__bundle-rows">
        {rows.map((row) => {
          ...
          return (
            <div key={row.id} className="processor-billing__bundle-row">
              <div
                role="button"
                tabIndex={0}
                className="processor-billing__bundle-row-head"
                aria-expanded={open}
              ...
              >
                <span className="processor-billing__bundle-row-label">
                  {row.label}
                </span>
                <span className="processor-billing__bundle-row-value">
                  {row.value}
                  <span className="processor-billing__bundle-row-change">
                    {open
                      ? t("processor.billing.prepaid.calc.done", "Done")
                      : t("processor.billing.prepaid.calc.change", "Change")}
                  </span>
                </span>
              </div>
              {open && (
                <div className="processor-billing__bundle-row-body">
                  <div className="processor-billing__bundle-cards">
                    {row.cards.map((card) => {
                      ...
                      return (
                        <div
                          ...
                          aria-pressed={active}
                          className={
                            "processor-billing__bundle-card" +
                            (active
                              ? " processor-billing__bundle-card--active"
                              : "")
                          }
                          onClick={pick}
                          onKeyDown={(e) => {
                        ...
                        >
                          <span className="processor-billing__bundle-card-head">
                            <span className="processor-billing__bundle-card-title">
                              {card.title}
                            </span>
                            {card.meta && (
                              <span className="processor-billing__bundle-card-meta">
                                {card.meta}
                              </span>
                            )}
                          </span>
                          <span className="processor-billing__bundle-card-desc">
                            {card.desc}
                          </span>
                        </div>
                      );
      ...
      {quote.overEnterprise && (
        <p className="processor-billing__bundle-savings">
          {t(
            "processor.billing.prepaid.calc.enterpriseHint",
...
function PaymentStep({
  ...
  const { t } = useTranslation();
  return (
    <div className="processor-billing__bundle-pay">
      {actionError && (
        <Banner
          tone="danger"
          title={t(
      ...
      {!poLocked && (
        <div className="processor-billing__bundle-fields">
          <FormField
            label={t(
              "processor.billing.prepaid.pay.accountName",
              "Account holder name",
            )}
            required
          >
            <Input
              ...
              placeholder={t(
                "processor.billing.prepaid.pay.accountNamePlaceholder",
                "e.g. Jane Smith",
              )}
            />
          </FormField>
          <div className="processor-billing__bundle-field-row">
            <FormField
              label={t(
                "processor.billing.prepaid.pay.companyName",
            ...
            >
              <Input
                ...
                placeholder={t(
                  "processor.billing.prepaid.pay.companyNamePlaceholder",
                  "e.g. Acme Inc.",
                )}
              />
            </FormField>
            <FormField
              label={t(
                "processor.billing.prepaid.pay.poNumber",
                "PO number (optional)",
              )}
            >
              <Input
                ...
                placeholder={t(
                  "processor.billing.prepaid.pay.poNumberPlaceholder",
                  "e.g. PO-2026-0142",
                )}
              />
            </FormField>
      ...
      {!poLocked && (
        <div className="processor-billing__bundle-consent">
          <Checkbox
            checked={consented}
            onChange={(e) => setConsented(e.currentTarget.checked)}
            label={t(
              "processor.billing.prepaid.consent.label",
      ...
      {poLocked && (
        <div className="processor-billing__bundle-foot-end">
          <Button
            variant="quiet"
          ...
          >
            {downloading
              ? t("processor.billing.prepaid.review.downloading", "Preparing…")
              : t(
                  "processor.billing.prepaid.pay.downloadInvoice",
                  "Download invoice",
                )}
          </Button>
        </div>
