...
import "@processor/components/billing/FreeTierPlanView.css";
      ...
      notices={
        <>
          <Banner
            ...
            tone="info"
            title={t(
              "processor.usage.freeTier.connectTitle",
