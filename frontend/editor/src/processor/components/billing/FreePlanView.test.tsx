...
import type { LatestBundleQuote } from "@processor/billing/stripe";
...
vi.mock("@processor/billing/stripe", async (importOriginal) => ({
  ...(await importOriginal<typeof import("@processor/billing/stripe")>()),
  ...api,
