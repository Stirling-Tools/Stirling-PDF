...
import { fetchIntegrationCapabilities } from "@processor/api/integrations";
...
export function PolicyExternalApiConfig({
  ...
  if (!selected) {
    ...
    return (
      <div className="processor-policies__capability-config">
        <div className="processor-conn-picker__search">
          ...
          <input
            ...
            placeholder={t("processor.policies.operations.searchPlaceholder")}
            aria-label={t("processor.policies.operations.searchPlaceholder")}
          />
        </div>

        {matches.length === 0 ? (
          <p className="processor-conn-picker__empty-body">
            {t("processor.policies.operations.noResults")}
          </p>
        ) : searching ? (
  ...
  return (
    <div className="processor-policies__capability-config">
      ...
      >
        {t("processor.policies.operations.change")}
      </Button>

      <p className="processor-policies__capability-summary">
      ...
      <FormField
        label={t("processor.policies.operations.fields.connection.label")}
        required
      >
        <ConnectionPicker
      ...
      {(selected.fields ?? []).map((field) => (
        ...
        >
          {field.control === "textarea" ? (
            <textarea
              className="processor-sources__connection-textarea"
              rows={3}
...
function CustomCallFields({
  ...
  return (
    <>
      <FormField
        label={t("processor.policies.operations.fields.path.label")}
        helperText={t("processor.policies.operations.fields.path.helperText")}
        required
      >
        <Input
          value={str("path")}
      ...
      <FormField label={t("processor.policies.operations.fields.method.label")}>
        <Select
      ...
      <FormField
        label={t("processor.policies.operations.fields.bodyMode.label")}
        helperText={t(
          "processor.policies.operations.fields.bodyMode.helperText",
        )}
      >
        <Select
          ...
          options={[
            {
              value: "multipart",
              label: t("processor.policies.operations.bodyMode.multipart"),
            },
            {
              value: "json",
              label: t("processor.policies.operations.bodyMode.json"),
            },
            {
              value: "binary",
              label: t("processor.policies.operations.bodyMode.binary"),
            },
          ]}
      ...
      {(str("bodyMode") || "multipart") === "multipart" && (
        <FormField
          label={t("processor.policies.operations.fields.fileFieldName.label")}
          helperText={t(
            "processor.policies.operations.fields.fileFieldName.helperText",
          )}
        >
          <Input
      ...
      <FormField
        label={t("processor.policies.operations.fields.responseMode.label")}
        helperText={t(
          "processor.policies.operations.fields.responseMode.helperText",
        )}
      >
        <Select
          ...
          options={[
            {
              value: "report",
              label: t("processor.policies.operations.responseMode.report"),
            },
            {
              value: "replace",
              label: t("processor.policies.operations.responseMode.replace"),
            },
          ]}
      ...
      <FormField
        label={t("processor.policies.operations.fields.headers.label")}
        helperText={t(
          "processor.policies.operations.fields.headers.helperText",
        )}
      >
        <textarea
          className="processor-sources__connection-textarea"
      ...
      {(str("bodyMode") || "multipart") === "json" && (
        <FormField
          label={t("processor.policies.operations.fields.bodyTemplate.label")}
          helperText={t(
            "processor.policies.operations.fields.bodyTemplate.helperText",
          )}
        >
          <textarea
            className="processor-sources__connection-textarea"
