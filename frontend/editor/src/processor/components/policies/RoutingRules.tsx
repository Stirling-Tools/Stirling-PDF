...
import "@processor/components/policies/RoutingRules.css";
...
export function RoutingRules({
  ...
  return (
    <>
      <Card padding="none">
        <div className="processor-routing__rules">
          {rules.map((rule, index) => (
            <div key={index} className="processor-routing__rule">
              <div className="processor-routing__row">
...
export function RoutingSection({ canClassify, ...rules }: RoutingSectionProps) {
  ...
  return (
    <>
      <div className="processor-routing__optin">
        <ToggleSwitch
          size="sm"
          checked={enabled}
      ...
      {enabled && (
        <>
          <h3 className="processor-routing__heading">
