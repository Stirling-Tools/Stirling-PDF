/**
 * Processor lens on the shared setup wizard: supplies the processor-only seams, the integrations
 * lookup that gates Purview steps, the Purview inline config and the processor's error copy.
 */
...
import { PolicyRoutingConfig } from "@processor/components/policies/PolicyRoutingConfig";
