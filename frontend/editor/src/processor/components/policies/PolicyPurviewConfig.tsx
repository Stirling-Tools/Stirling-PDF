...
export function PolicyPurviewConfig({
  ...
  return (
    <div className="processor-policies__capability-settings">
      <FormField
        label={t("processor.policies.config.purview.fields.connection")}
        required
      >
        <ConnectionPicker
      ...
      <FormField
        label={t("processor.policies.config.purview.fields.labelId")}
        helperText={t("processor.policies.config.purview.fields.labelIdHelp")}
        required
      >
        <Input
      ...
      <FormField
        label={t("processor.policies.config.purview.fields.labelName")}
        helperText={t("processor.policies.config.purview.fields.labelNameHelp")}
      >
        <Input
      ...
      <FormField
        label={t("processor.policies.config.purview.fields.method.label")}
        helperText={t("processor.policies.config.purview.fields.method.help")}
      >
        <Select
          ...
          options={[
            {
              value: "STANDARD",
              label: t(
                "processor.policies.config.purview.fields.method.standard",
              ),
            },
            {
              value: "PRIVILEGED",
              label: t(
                "processor.policies.config.purview.fields.method.privileged",
              ),
            },
          ]}
