...
vi.mock("@processor/contexts/ViewContext", () => ({
...
vi.mock("@processor/components/infrastructure/AuditTab", () => ({
  AuditTab: () => <div data-testid="audit-tab" />,
}));
vi.mock("@processor/components/infrastructure/EncryptionPanel", () => ({
  EncryptionPanel: () => <div data-testid="storage-tab" />,
}));

import { Infrastructure } from "@processor/views/Infrastructure";

const T = "processor.infrastructure.tabs";
