vi.mock("@processor/queries/infrastructure", () => ({
...
vi.mock("@processor/hooks/useBundleFlowState", () => ({
...
vi.mock("@processor/components/procurement/useProcurement", () => ({
  useProcurement: () => procurement,
}));
vi.mock("@processor/components/procurement/ProcurementBanner", () => ({
...
vi.mock("@processor/components/procurement/ProcurementFlow", () => ({
  ProcurementFlow: () => <div data-testid="procurement-flow" />,
}));
vi.mock("@processor/api/fleetStats", () => ({
  fetchFleetStats: () => Promise.resolve(null),
}));
vi.mock("@processor/api/users", () => ({
