...
import { PipelineHeader } from "@processor/components/pipelines/PipelineHeader";
  ...
  async function handleRun() {
    ...
    try {
      ...
      if (failed) {
        ...
        setRunResult({
          tone: "success",
          text: t("processor.pipelines.run.completed", {
            count: finals.length,
          }),
        });
      } else {
  ...
  async function handleClearHistory() {
    ...
    try {
      ...
      if (mounted.current)
        setRunResult({
          tone: "success",
          text: t("processor.pipelines.run.historyCleared"),
        });
    } catch (e) {
      if (mounted.current)
        setRunResult({ tone: "danger", text: errorMessage(e) });
