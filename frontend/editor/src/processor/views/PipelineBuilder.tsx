...
export function PipelineBuilder() {
  ...
  if (hasUploadSteps)
    blockers.push(
      t("processor.pipelines.builder.blocker.upload", {
  ...
  function stepWarning(step: WorkingToolStep): string | undefined {
    ...
    if (stepRequiresUpload(step))
      return t("processor.pipelines.builder.needsUpload");
        ...
        <>
          {hasSources && (
            <>
              ...
              <FormField label={t("processor.pipelines.builder.inputTrigger")}>
                <Select
                  inputSize="sm"
                  aria-label={t("processor.pipelines.builder.inputTrigger")}
                  value={
              ...
              {input.triggerType === "schedule" && (
                <div className="processor-builder__schedule">
                  <span className="processor-builder__muted">
                    {t("processor.pipelines.composer.scheduleEvery")}
                  </span>
                  <Input
                    inputSize="sm"
                    type="number"
                    ...
                    className="processor-builder__schedule-count"
                  />
                  <Select
                    inputSize="sm"
  ...
  return (
    <div className="processor-builder">
      ...
      {hasUploadSteps && (
        <Banner
          tone="warning"
          description={t("processor.pipelines.builder.uploadUnsupported", {
            tools: uploadStepLabels.join(", "),
          })}
        />
      )}
