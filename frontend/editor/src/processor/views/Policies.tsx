...
import { CatalogueSummary } from "@processor/components/policies/CatalogueSummary";
import { PolicyCatalogueTable } from "@processor/components/policies/PolicyCatalogueTable";
...
export function Policies() {
  ...
  return (
    <div className="processor-policies">
      <header className="processor-policies__head">
        <h1 className="processor-policies__title">
          {t("processor.policies.title")}
        </h1>
        <p className="processor-policies__sub">
          {t("processor.policies.subtitle")}
        </p>
      </header>
      ...
      {isLoading && (
        <div className="processor-policies__grid" aria-hidden>
      ...
      {!isLoading && fetchError && (
        <Banner
          tone="warning"
          title={t("processor.policies.offline.title")}
          description={t("processor.policies.offline.description")}
          action={
            <Button variant="secondary" size="sm" onClick={refetch}>
              {t("processor.policies.offline.retry")}
            </Button>
          }
        />
      )}
