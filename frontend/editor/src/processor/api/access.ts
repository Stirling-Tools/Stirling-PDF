...
/**
 * Access-control service layer: the ResourceGrant ACL the processor admin drives.
 *
 * Grants sit on top of the default policy (admins + team leads may enter the
 * processor; owners/admins may use their configs). A grant widens that: a PORTAL
