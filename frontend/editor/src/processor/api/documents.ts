...
export const DOCUMENT_STATUS_LABEL: Record<DocumentStatus, string> = {
  processed: "processor.documents.status.processed",
  flagged: "processor.documents.status.flagged",
  "in-review": "processor.documents.status.inReview",
  error: "processor.documents.status.error",
};
...
export const DOC_AUDIT_LABEL: Record<DocAuditKind, string> = {
  ingested: "processor.documents.audit.ingested",
  extracted: "processor.documents.audit.extracted",
  flagged: "processor.documents.audit.flagged",
  reviewed: "processor.documents.audit.reviewed",
  approved: "processor.documents.audit.approved",
  archived: "processor.documents.audit.archived",
  elevation: "processor.documents.audit.elevation",
};
