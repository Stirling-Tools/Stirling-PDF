...
export const FLOW_JOURNEY: JourneyStep[] = [
  {
    stage: "trial",
    label: "processor.procurement.journeySteps.trial.label",
    blurb: "processor.procurement.journeySteps.trial.blurb",
    gatingAction: "processor.procurement.journeySteps.trial.gatingAction",
  },
  {
    stage: "quote",
    label: "processor.procurement.journeySteps.quote.label",
    blurb: "processor.procurement.journeySteps.quote.blurb",
    gatingAction: "processor.procurement.journeySteps.quote.gatingAction",
  },
  {
    stage: "security",
    label: "processor.procurement.journeySteps.agreement.label",
    blurb: "processor.procurement.journeySteps.agreement.blurb",
    gatingAction: "processor.procurement.journeySteps.agreement.gatingAction",
  },
  {
    stage: "procurement",
    label: "processor.procurement.journeySteps.payment.label",
    blurb: "processor.procurement.journeySteps.payment.blurb",
    gatingAction: "processor.procurement.journeySteps.payment.gatingAction",
  },
  {
    stage: "active",
    label: "processor.procurement.journeySteps.implementation.label",
    blurb: "processor.procurement.journeySteps.implementation.blurb",
    gatingAction:
      "processor.procurement.journeySteps.implementation.gatingAction",
  },
];
...
export interface ProcurementSnapshot {
  ...
  licensed: boolean;
  /** The team's Keygen licence key (present once licensed); shown in the processor to copy/install. */
...
// that own Stripe; they persist results back through SECURITY DEFINER RPCs. The processor invokes them
 ...
 * data is normally intercepted — so until this existed they were never mocked. The processor has no
