...
/**
 * Locally-accrued usage not yet reported to SaaS — the processor adds this on top of the SaaS-synced spend so "current usage" includes work done since the last daily sync.
 */
