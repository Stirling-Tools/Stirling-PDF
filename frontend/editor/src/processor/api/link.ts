 ...
 * The processor adds this on top of the SaaS-synced spend so "current usage"
 ...
 *                                          secret SERVER-SIDE; the processor
...
/**
 * Locally-accrued usage not yet reported to SaaS — the processor adds this on top
