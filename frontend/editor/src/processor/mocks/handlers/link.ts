...
import type { LinkInstanceRequest } from "@processor/api/link";
import {
  getLocalStatus,
  getLocalUsage,
  linkLocal,
...
export const linkHandlers = [
  ...
  // returns 204 (or 409 when metering is off). The processor fires it best-effort
