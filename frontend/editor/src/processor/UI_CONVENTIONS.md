# Processor UI conventions — SUI vs Mantine

The processor has one component source from the caller's point of view: **SUI
...
Anything that needs processors, focus traps, ARIA keyboard patterns, or is just a
