 ...
 * a sibling to TierContext. It answers one question the rest of the processor asks:
 ...
 *
 * The processor admin establishes the link by signing in to the SaaS Supabase
...
export const LINK_INFO: Record<LinkState, LinkInfo> = {
  unlinked: {
    labelKey: "processor.accountLink.state.unlinked",
    labelDefault: "Not linked",
    unlocked: false,
  },
  "linked-free": {
    labelKey: "processor.accountLink.state.free",
    labelDefault: "Editor plan",
    unlocked: true,
  },
  "linked-subscribed": {
    labelKey: "processor.accountLink.state.subscribed",
...
/**
 * Null rather than throwing where there is no provider. The SaaS processor mounts none on purpose, so
