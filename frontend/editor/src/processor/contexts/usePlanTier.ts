...
/** Maps the self-hosted link/subscription state onto the processor tier. */
...
/**
 * The plan tier the processor runs on, self-hosted flavor: derived from whether the
 ...
 * no link concept there (see processor-saas/contexts/usePlanTier).
 */
