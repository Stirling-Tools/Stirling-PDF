...
import type { McpCardProps } from "@app/components/shared/config/configSections/server/serverCardProps";
...
/** The MCP endpoint, how it authenticates, and which tools it exposes. */
