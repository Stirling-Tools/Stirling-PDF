...
export default defineConfig(
  ...
  // the lint step (builds the whole TS program); tsc covers type correctness.
  {
    ...
    ignores: [
      ...
      "editor/src/core/components/shared/signing/**/*.{js,mjs,jsx,ts,tsx}",
      "editor/src/core/components/tools/*.{js,mjs,jsx,ts,tsx}",
      "editor/src/core/components/tools/addAttachments/**/*.{js,mjs,jsx,ts,tsx}",
      "editor/src/core/components/tools/addPageNumbers/**/*.{js,mjs,jsx,ts,tsx}",
      "editor/src/core/components/tools/addStamp/**/*.{js,mjs,jsx,ts,tsx}",
      "editor/src/core/components/tools/adjustContrast/**/*.{js,mjs,jsx,ts,tsx}",
      ...
      "editor/src/core/components/tools/compare/**/*.{js,mjs,jsx,ts,tsx}",
      "editor/src/core/components/tools/extractImages/**/*.{js,mjs,jsx,ts,tsx}",
      ...
      "editor/src/core/components/viewer/hooks/**/*.{js,mjs,jsx,ts,tsx}",
      ...
      "editor/src/core/hooks/tools/automate/**/*.{js,mjs,jsx,ts,tsx}",
      "editor/src/core/hooks/tools/compare/**/*.{js,mjs,jsx,ts,tsx}",
      "editor/src/core/hooks/tools/convert/**/*.{js,mjs,jsx,ts,tsx}",
      "editor/src/core/hooks/tools/merge/**/*.{js,mjs,jsx,ts,tsx}",
