...
const THEME = resolve(process.cwd(), "src/editor/core/theme");
...
const TOKENS_CSS = resolve(process.cwd(), "src/editor/core/tokens/tokens.css");
...
const PRIMITIVE_LAYER = [
  /^src\/editor\/core\/theme\//,
  /^src\/editor\/core\/styles\/theme\.css$/,
  /^src\/editor\/core\/tokens\/tokens\.css$/,
  /^src\/editor\/proprietary\/auth\/ui\/auth-theme\.css$/,
  /^src\/editor\/core\/ui\/accents\.css$/,
];
