 ...
 *   files live one level deeper at frontend/. `import.meta` is only
 *   valid in ESM output; `scripts/tsconfig.json` extends the editor
...
// .env files live next to the editor's vite.config.ts (frontend/).
