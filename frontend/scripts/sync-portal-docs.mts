 ...
 * src/processor/proprietary/docs/manifest/transform.ts, and writes the committed manifest that
...
import {
  ...
  type CategoryMap,
  type RawDoc,
} from "../src/processor/proprietary/docs/manifest/transform.ts";
...
const OUT = resolve(HERE, "../src/processor/proprietary/generated/docsManifest.json");
