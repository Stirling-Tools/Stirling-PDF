 ...
 * src/editor/core/docs/manifest/transform.ts, and writes the committed manifest that
...
import {
  ...
  type CategoryMap,
  type RawDoc,
} from "../src/editor/core/docs/manifest/transform.ts";
...
const OUT = resolve(HERE, "../src/editor/core/generated/docsManifest.json");
