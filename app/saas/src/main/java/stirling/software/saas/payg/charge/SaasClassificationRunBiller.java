...
/**
 * SaaS billing for a client-side classification run: charges one PAYG unit per document as an
 * AUTOMATION job, mirroring what a server-side classify policy step bills.
 */
@Component
@Profile("saas")
