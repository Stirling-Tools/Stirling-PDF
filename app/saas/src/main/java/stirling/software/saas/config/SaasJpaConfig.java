 ...
 * (stirling.software.saas.repository, .billing.repository, .ai.repository, .payg.repository) and
 * @EntityScan packages (.model, .billing.model, .ai.model, .payg) are no longer needed.
 */
@ApplicationScoped
@IfBuildProfile("saas")
