...
class McpApiKeyIntegrationTest {
    ...
    void validApiKeyViaHeader_callsToolsList() throws Exception {
        HttpResponse<String> response = postMcp(
                b -> b.header("X-API-KEY", VALID_KEY), "{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"tools/list\"}");
    ...
    void noKey_isRejectedWith401() throws Exception {
        HttpResponse<String> response = postMcp(b -> b, "{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"ping\"}");
    ...
    void wrongKey_isRejectedWith401() throws Exception {
        HttpResponse<String> response = postMcp(
                b -> b.header("X-API-KEY", "not-a-real-key"), "{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"ping\"}");
        assertThat(response.statusCode()).isEqualTo(401);
    }
    ...
    private HttpResponse<String> postMcp(java.util.function.UnaryOperator<HttpRequest.Builder> headers, String body)
            throws Exception {
    ...
    static class TestApp {
        ...
        UserService userService() {
            ...
            org.mockito.Mockito.when(mock.getUserByApiKey(VALID_KEY)).thenReturn(Optional.of(account));
            return mock;
        }
    }
}
