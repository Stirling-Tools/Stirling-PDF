...
class ProcessorInfraAuditServiceTest {

    @Mock private ProcessorAuditReadService auditReadService;

    private ProcessorInfraAuditService service;

    @BeforeEach
    void setUp() {
        service = new ProcessorInfraAuditService(auditReadService, JsonMapper.builder().build());
    }
