...
class NotificationProjectionTest {
    ...
    @Mock
    private PolicyManagementAuthority authority;
    ...
    void setUp() {
        ...
        failures = new FileRunEventService(
                store,
                new FailureActionRegistry(List.of(new AcknowledgeAction(store), new DismissAction(store))),
                authority,
                userService,
                props);
    ...
    class Ids {
        ...
        void everyNotificationIsKeyedByItsSourceAndRowId() {
            ...
            NotificationView notification =
                    controller.list(null).notifications().getFirst();
    ...
    class Projection {
        ...
        void carriesTheKindOriginOwnershipAndTheQueuesClientActions() {
            ...
            assertThat(notification.actions())
                    .containsExactlyElementsOf(
                            FileRunEventView.of(mine, failures.availableActions(mine)).actions().stream()
                                    .filter(action -> action.execution() == FailureActionId.Execution.CLIENT)
                                    .toList());
        }
        ...
        void keepsARunScopedFailureThatStillNamesADocument() {
            ...
            assertThat(controller.list(null).notifications()).singleElement().satisfies(row -> {
        ...
        void namesTheSourceThatFedAnUnattendedRunSoItsFileIdIsNotMistakenForAClientsOwn() {
            ...
            // missing.
            store.record(RecordFailure.forRun(
