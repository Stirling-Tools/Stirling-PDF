...
class PolicyFailureOwnershipTest {
    ...
    void setUp() {
        ...
        service = new FileRunEventService(
                store,
        ...
        PolicyFailureRecorder recorder = new PolicyFailureRecorder(
    ...
    private void runAndFail(String triggeredBy, String sourceId, String fileIdentity) throws Exception {
        ...
        void theRowIsOwnedByNobodySoTheReviewerInheritsTheOwnerActions() throws Exception {
            ...
            assertThat(service.availableActions(unattended))
                    ...
                    .satisfies(action -> {
                        ...
                        assertThat(action.disabledReasonKey()).isEqualTo("portal.failures.disabled.unattended");
                    });
        }
