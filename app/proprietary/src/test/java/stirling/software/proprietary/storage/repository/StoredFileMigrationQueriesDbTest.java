...
class StoredFileMigrationQueriesDbTest {
    ...
    void findMigratableAfter_selectsOnlyPlaintextRows_inIdOrder_withOwnerFetched() {
        ...
        assertThat(page).extracting(StoredFile::getId).containsExactly(plain1.getId(), plain2.getId());
    ...
    void findMigratableAfter_cursorAndPageSizeAreHonoured() {
        ...
        assertThat(repository.findMigratableAfter(second.getId(), PageRequest.of(0, 10)))
                .isEmpty();
    }
    ...
    void swapMainBlob_appliesOnlyWhenStorageKeyStillMatches() {
        ...
        assertThat(repository.swapMainBlob(file.getId(), "k-stale", "k-new", keyId))
                .isZero();

        assertThat(repository.swapMainBlob(file.getId(), "k-old", "k-new", keyId))
                .isEqualTo(1);
        entityManager.clear();
    ...
    void swapSecondaryBlobs_applyIndependentlyAndLeaveKeyIdAlone() {
        ...
        assertThat(repository.swapHistoryBlob(file.getId(), "k-wrong", "k-hist-new"))
                .isZero();
