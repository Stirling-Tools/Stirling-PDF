...
class AuditCleanupServiceTest {
    ...
    private final PersistentAuditEventRepository repository = mock(PersistentAuditEventRepository.class);
    ...
    private AuditCleanupService service(boolean runningEE, int retentionDays) {
        ...
        return new AuditCleanupService(repository, new AuditConfigurationProperties(props), runningEE);
    }
