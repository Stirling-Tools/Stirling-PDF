...
class NotificationResolveTest {
    ...
    void closesTheRowBehindThePrefixedId() {
        ...
        assertThat(store.find(event.id(), TEAM).orElseThrow().status()).isEqualTo(FileRunEventStatus.RESOLVED);
    }
    ...
    void theRowsOwnIdIsNotANotificationId() {
        ...
        assertThat(statusOf(() -> controller.resolved(event.id()))).isEqualTo(HttpStatus.BAD_REQUEST);
    ...
    void anUnknownSourcePrefixIsABadRequest() {
        ...
        assertThat(statusOf(() -> controller.resolved("quota:" + event.id()))).isEqualTo(HttpStatus.BAD_REQUEST);
        assertThat(statusOf(() -> controller.resolved("failure:"))).isEqualTo(HttpStatus.BAD_REQUEST);
    }
    ...
    void aRowAReviewerHasDismissedIsAConflict() {
        ...
        assertThat(statusOf(() -> controller.resolved("failure:" + event.id()))).isEqualTo(HttpStatus.CONFLICT);
        assertThat(store.find(event.id(), TEAM).orElseThrow().status()).isEqualTo(FileRunEventStatus.DISMISSED);
    }
    ...
    void aReviewerClosesAColleaguesRowTheyFixed() {
        ...
        assertThat(store.find(theirs.id(), TEAM).orElseThrow().status()).isEqualTo(FileRunEventStatus.RESOLVED);
    }
}
