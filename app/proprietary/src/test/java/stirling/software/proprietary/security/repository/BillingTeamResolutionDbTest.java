...
class BillingTeamResolutionDbTest {
    ...
    void usersTeamIdIsTheJoinedTeamWhileTheOldestMembershipIsTheHomeTeam() {
        ...
        TeamMembership oldest = membershipRepository.findByUserId(reloaded.getId()).stream()
        ...
        TeamMembership billingRow = membershipRepository
    ...
    @EntityScan(basePackages = {"stirling.software.proprietary.security.model", "stirling.software.proprietary.model"})
