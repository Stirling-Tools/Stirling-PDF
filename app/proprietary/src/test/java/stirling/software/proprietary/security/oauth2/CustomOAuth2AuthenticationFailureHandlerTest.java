...
class CustomOAuth2AuthenticationFailureHandlerTest {
    ...
    void redirectsToTauriCallbackWhenStateMarked() throws Exception {
        CustomOAuth2AuthenticationFailureHandler handler = new CustomOAuth2AuthenticationFailureHandler();
        ...
        assertEquals("/auth/callback/tauri?state=tauri%3Aabc&errorOAuth=access_denied", response.getRedirectedUrl());
    }
