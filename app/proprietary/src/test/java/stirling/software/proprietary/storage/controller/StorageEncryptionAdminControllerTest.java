...
class StorageEncryptionAdminControllerTest {
    ...
    void setUp() {
        ...
        keyService = new FileEncryptionKeyService(keyRepo.mock, new FileEncryptionMasterKey(MASTER, false));
        ...
        controller = new StorageEncryptionAdminController(
                storageEnabled(true),
                StorageEncryptionState.of(true, keyService, StorageEncryptionAuditListener.NOOP),
                keyRepo.mock,
    ...
    void rotate_whenInactive_conflicts() {
        StorageEncryptionAdminController inactive = new StorageEncryptionAdminController(
                storageEnabled(true),
    ...
    void status_storageDisabled_refusesWithoutTouchingTheRegistry() {
        StorageEncryptionAdminController storageOff = new StorageEncryptionAdminController(
                storageEnabled(false),
                StorageEncryptionState.of(false, keyService, StorageEncryptionAuditListener.NOOP),
                keyRepo.mock,
                storedFileRepository,
                migrationService,
                mock(AuditService.class));
    ...
    void status_unreadableRegistry_reports503RatherThanRaw500() {
        ...
        when(broken.findAll(any(Sort.class))).thenThrow(new InvalidDataAccessResourceUsageException("no such table"));
        StorageEncryptionAdminController brokenRegistry = new StorageEncryptionAdminController(
                storageEnabled(true),
                StorageEncryptionState.of(true, keyService, StorageEncryptionAuditListener.NOOP),
                broken,
                storedFileRepository,
