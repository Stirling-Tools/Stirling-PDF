...
public class ProcessorInfraAuditService {
    ...
    private InfraAuditLogResponse buildFromEvents(
            List<ProcessorAuditEventRow> recent, boolean fullServer) {
    ...
    private InfraAuditEventDto toDto(ProcessorAuditEventRow event) {
