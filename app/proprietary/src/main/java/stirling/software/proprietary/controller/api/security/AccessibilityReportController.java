...
public class AccessibilityReportController {
    ...
    @Operation(
            ...
            description = "Validates the document against PDF/UA and reports what fails, which failures"
    ...
    public ResponseEntity<AccessibilityReport> report(@ModelAttribute AccessibilityReportRequest request) {
