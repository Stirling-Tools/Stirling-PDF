...
/**
 * Real backing for the processor Infrastructure → API Keys tab: list/create/revoke named, personal
 * API keys. Replaces the former processor-only mock endpoint. Not gated behind an Enterprise
 * license - API keys are a core auth feature available on every self-hosted instance.
 */
@ProprietaryUiDataApi
@RequiredArgsConstructor
public class ProcessorApiKeysController {
    ...
    public ResponseEntity<ProcessorApiKeysResponse> list(
