 ...
 */
public record ResolvedInput(PolicyInputs inputs, String fileIdentity, Consumer<Boolean> onComplete) {
     ...
     */
    public static ResolvedInput forFile(PolicyInputs inputs, String identity, Consumer<Boolean> onComplete) {
        return new ResolvedInput(inputs, identity == null ? null : IdentityHasher.identityHash(identity), onComplete);
    }
