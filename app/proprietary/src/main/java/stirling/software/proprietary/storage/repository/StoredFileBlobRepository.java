 ...
 *
 * <p>Migrated from a Spring Data {@code JpaRepository<StoredFileBlob, String>}. The String id
 * keeps {@link PanacheRepositoryBase} with {@code <StoredFileBlob, String>}; callers map
 * {@code save -> persist}, {@code findById -> findByIdOptional}, {@code deleteById -> deleteById}.
 */
@ApplicationScoped
