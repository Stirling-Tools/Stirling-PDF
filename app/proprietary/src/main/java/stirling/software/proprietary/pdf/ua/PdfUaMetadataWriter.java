...
public class PdfUaMetadataWriter {
    ...
    public List<String> applyDocumentRequirements(
            PDDocument document, String title, String language, PdfUaProfile profile) throws IOException {
        return applyDocumentRequirements(document, title, language, profile, false);
    }

    public List<String> applyDocumentRequirements(
            PDDocument document, String title, String language, PdfUaProfile profile, boolean preserveVersion)
            throws IOException {
     ...
     */
    private void writeXmp(PDDocument document, String title, String language, PdfUaProfile profile) throws IOException {
    ...
    private static void serialiseInto(PDDocument document, XMPMetadata metadata) throws IOException {
