...
public class PolicyEngine {
    ...
    public PolicyRunHandle submit(
        ...
        return submitForPrincipal(principal, principal, principal, policyId, definition, inputs, listener, null, null);
    }
    ...
    public PolicyRunHandle runPolicy(
            Policy policy, PolicyInputs inputs, PolicyProgressListener listener, String sourceId, String fileIdentity) {
    ...
    private PolicyRunHandle submitForPrincipal(
        ...
        PolicyRun run = new PolicyRun(runId, policyId, definition, sourceId, fileIdentity, triggeringUser);
