...
public record S3Config(
    ...
    public static S3Config from(Map<String, Object> options) {
        ...
        if (objectLockMode != null) {
            ...
            if (!LOCK_GOVERNANCE.equals(objectLockMode) && !LOCK_COMPLIANCE.equals(objectLockMode)) {
                throw new IllegalArgumentException("s3 config 'objectLockMode' must be 'GOVERNANCE' or 'COMPLIANCE'");
            }
        }
        ...
        if ((objectLockMode == null) != (retentionDays == null)) {
            throw new IllegalArgumentException("s3 config 'objectLockMode' and 'retentionDays' must be set together");
        }
