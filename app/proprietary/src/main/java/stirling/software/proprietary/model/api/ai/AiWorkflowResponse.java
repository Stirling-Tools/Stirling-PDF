...
public class AiWorkflowResponse {
    ...
    @Schema(description = "Unsupported capability identifier when the workflow cannot route the request")
    ...
    @Schema(description = "Tool endpoint path for tool_call outcomes (e.g. /api/v1/misc/compress-pdf)")
    private String tool;
    ...
    @Schema(
            description = "Result files produced by the workflow. Always populated on completed outcomes"
    ...
    @Schema(
            description = "Files the AI engine requires to be ingested into RAG before it can continue"
    ...
    @Schema(
            description = "Optional structured report from the tool (e.g. math-auditor Verdict, PDF"
    ...
    @Schema(
            description = "Structured error code when a downstream tool call was blocked (e.g."
    ...
    @Schema(
            description = "Whether the team is subscribed, carried from a downstream usage-limit response."
