 ...
 * the interceptor must be enabled (Quarkus enables {@code @Interceptor} beans automatically once
 * the binding is an {@code @InterceptorBinding}; no beans.xml ordering change needed). It already
