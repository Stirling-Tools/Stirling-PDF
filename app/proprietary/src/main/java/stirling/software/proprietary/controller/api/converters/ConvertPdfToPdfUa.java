...
public class ConvertPdfToPdfUa {
    ...
    @Operation(
            ...
            description = "Tags the document, marks decorative content as artifacts, embeds fonts and"
    ...
    public ResponseEntity<Resource> pdfToPdfUa(@ModelAttribute PdfToPdfUaRequest request) throws IOException {
        ...
        TaggingOptions options = TaggingOptions.builder()
                ...
                .language(
                        request.getLanguage() == null || request.getLanguage().isBlank()
                                ? "en-GB"
                                : request.getLanguage())
                .overrideLanguage(request.getOverrideLanguage() != null && request.getOverrideLanguage())
        ...
        ResponseEntity<Resource> response = WebResponseUtils.pdfFileToWebResponse(tempOut, stem + suffix + ".pdf");
        ...
        return ResponseEntity.status(response.getStatusCode())
                ...
                .header(HEADER_ALT_NEEDED, String.valueOf(outcome.tagging().figuresNeedingAltText()))
