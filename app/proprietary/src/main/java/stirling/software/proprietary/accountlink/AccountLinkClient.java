...
public class AccountLinkClient {
    ...
    public record ConnectRequestResult(String requestId, int expiresInSeconds, String authorizeUrl) {}
    ...
    public record ConnectClaimResult(ConnectClaimOutcome outcome, String deviceId, String deviceSecret, Long teamId) {
    ...
    public ConnectRequestResult connectRequest(String name, String callbackUrl, String nonce, String claimSecret)
            throws IOException {
    ...
    public ConnectRequestResult connectRequest(
            String name, String callbackUrl, String nonce, String claimSecret, DeviceCredential credential)
            throws IOException {
    ...
    public ConnectClaimResult connectClaim(String requestId, String claimSecret) {
        ...
        try {
            ...
            return new ConnectClaimResult(ConnectClaimOutcome.GRANTED, deviceId, deviceSecret, teamId);
