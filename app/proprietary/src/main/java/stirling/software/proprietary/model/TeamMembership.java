...
@Table(
        ...
        indexes = {
            @Index(name = "idx_team_memberships_user_role", columnList = "user_id, role"), // leader-set lookups
            @Index(name = "idx_team_memberships_team_role", columnList = "team_id, role") // per-team member lists
        })
@NoArgsConstructor
@Getter
@Setter
