...
public record RecordFailure(
    ...
    public static RecordFailure forRun(
            ...
            String fileId,
            String detail) {
        return new RecordFailure(kind, FailureOrigin.POLICY, teamId, actor, policyId, runId, sourceId, fileId, detail);
    }
     ...
     */
    public static RecordFailure forEditor(FailureKind kind, Long teamId, String actor, String fileId, String detail) {
        return new RecordFailure(kind, FailureOrigin.TOOL, teamId, actor, null, null, null, fileId, detail);
    }
