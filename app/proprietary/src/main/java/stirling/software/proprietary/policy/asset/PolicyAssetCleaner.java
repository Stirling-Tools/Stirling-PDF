...
public class PolicyAssetCleaner {
    ...
    PolicyAssetCleaner(PolicyAssetStore assetStore, PolicyStore policyStore, Supplier<Instant> clock) {
            ...
            for (String id : candidates) {
                ...
                assetStore
                        ...
                        .ifPresent(asset -> {
                            ...
                            log.debug("Deleted unreferenced policy asset {} ({})", id, asset.fileName());
                        });
            }
        } catch (RuntimeException e) {
