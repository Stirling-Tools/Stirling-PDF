...
public class StorageEncryptionState {
    ...
    public static StorageEncryptionState of(
            boolean writeEnabled, FileEncryptionKeyService keyService, StorageEncryptionAuditListener auditListener) {
        StorageEncryptionState state = new StorageEncryptionState(writeEnabled, () -> keyService, null, auditListener);
