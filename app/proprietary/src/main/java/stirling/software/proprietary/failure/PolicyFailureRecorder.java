...
public class PolicyFailureRecorder {
    ...
    public void recordRunFailureAs(
            FailureKind kind, String runId, String policyId, String sourceId, String actor, String detail) {
    ...
    private void record(
        ...
        try {
            store.record(RecordFailure.forRun(
                    kind, teamFor(policyId), actor, policyId, runId, sourceId, fileIdentity, detail));
