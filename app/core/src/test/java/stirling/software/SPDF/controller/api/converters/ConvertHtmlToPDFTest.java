...
class ConvertHtmlToPDFTest {
    ...
    @InjectMocks
    private ConvertHtmlToPDF controller;
    ...
    void htmlToPdf_validHtmlFile() throws Exception {
        ...
        MockMultipartFile file = new MockMultipartFile("fileInput", "test.html", "text/html", htmlContent);
        HTMLToPdfRequest request = new HTMLToPdfRequest();
        request.setFileInput(file);
    ...
    void htmlToPdf_validZipFile() throws Exception {
        ...
        MockMultipartFile file = new MockMultipartFile("fileInput", "archive.zip", "application/zip", zipContent);
        HTMLToPdfRequest request = new HTMLToPdfRequest();
        request.setFileInput(file);
    ...
    void htmlToPdf_nullFilenameThrows() {
        MockMultipartFile file = new MockMultipartFile("fileInput", null, "text/html", "content".getBytes());
        HTMLToPdfRequest request = new HTMLToPdfRequest();
        request.setFileInput(file);
