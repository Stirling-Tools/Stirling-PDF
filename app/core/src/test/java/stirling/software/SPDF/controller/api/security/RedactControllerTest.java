...
class RedactControllerTest {
    ...
    private static PDFont helvetica(PDDocument doc) throws IOException {
        try (InputStream is =
                RedactControllerTest.class.getResourceAsStream("/type3/library/fonts/dejavu/DejaVuSans.ttf")) {
            if (is != null) {
    ...
    class ContentStreamUnitTests {
        ...
        void shouldPerformTextReplacement() throws Exception {
            ...
            boolean fallback =
                    textRedactionService.performTextReplacement(realDocument, found, targetWords, false, false);
