...
class AttachmentServiceTest {
    ...
    @Nested
    @DisplayName("Add Attachment to PDF Tests")
    class AddAttachmentToPdfTests {

        @Test
        @DisplayName("Adds single attachment to PDF successfully")
        ...
        @Test
        @DisplayName("Adds multiple attachments to PDF successfully")
        ...
        @Test
        @DisplayName("Adds attachment with blank content type to PDF successfully")
        ...
        @Test
        @DisplayName("Handles IOException from attachment input stream gracefully")
