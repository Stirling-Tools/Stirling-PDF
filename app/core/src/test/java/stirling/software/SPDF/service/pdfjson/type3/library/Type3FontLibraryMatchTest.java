...
class Type3FontLibraryMatchTest {
    ...
    void valueSemantics() {
        Type3FontLibraryEntry entry =
                Type3FontLibraryEntry.builder().id("e1").label("E1").build();
        Type3FontLibraryMatch a = Type3FontLibraryMatch.builder()
                .entry(entry)
                .matchType("signature")
                .signature("sha256:abc")
                .build();
        Type3FontLibraryMatch b = Type3FontLibraryMatch.builder()
                .entry(entry)
                .matchType("signature")
                .signature("sha256:abc")
                .build();
    ...
    void builder_aliasMatchType() {
        Type3FontLibraryEntry entry =
                Type3FontLibraryEntry.builder().id("e2").label("E2").build();
        Type3FontLibraryMatch match = Type3FontLibraryMatch.builder()
                .entry(entry)
