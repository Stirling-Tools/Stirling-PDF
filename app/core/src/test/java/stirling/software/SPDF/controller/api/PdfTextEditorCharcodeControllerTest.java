...
class PdfTextEditorCharcodeControllerTest {
    ...
    private static PdfTextEditorCharcodeController controller() {
        return new PdfTextEditorCharcodeController(new CustomPDFDocumentFactory(mock(PdfMetadataService.class)));
    }

    private static String mushroomBase64() throws Exception {
        try (InputStream in =
                PdfTextEditorCharcodeControllerTest.class.getResourceAsStream("/pdftexteditor/mushroom-life.pdf")) {
    ...
    void absentLocatorCharReturns200WithError() throws Exception {
        ...
        ResponseEntity<EncodeCharcodesResponse> resp = controller().encodeCharcodes(requestWithLocator("￿"));
        ...
        try (PDDocument doc = new PDDocument()) {
            ...
            for (int n = 0; n < filler; n++) {
                Standard14Fonts.FontName fn =
                        (n % 2 == 0) ? Standard14Fonts.FontName.SYMBOL : Standard14Fonts.FontName.ZAPF_DINGBATS;
                resources.put(org.apache.pdfbox.cos.COSName.getPDFName("Ff" + n), new PDType1Font(fn));
            }
            if (trailingTarget) {
                resources.put(
    ...
    private static org.apache.pdfbox.cos.COSDictionary subsetFontDict(
            PDDocument doc, String baseName, byte[] fontProgram, byte[] toUnicode) throws Exception {
        ...
        font.setItem(org.apache.pdfbox.cos.COSName.SUBTYPE, org.apache.pdfbox.cos.COSName.TRUE_TYPE);
        if (baseName != null) {
        ...
        if (fontProgram != null) {
            org.apache.pdfbox.pdmodel.common.PDStream ff2 =
                    new org.apache.pdfbox.pdmodel.common.PDStream(doc, new java.io.ByteArrayInputStream(fontProgram));
        ...
        org.apache.pdfbox.pdmodel.common.PDStream tu =
                new org.apache.pdfbox.pdmodel.common.PDStream(doc, new java.io.ByteArrayInputStream(toUnicode));
    ...
    private static final byte[] PROGRAM_A = "fake-ttf-program-A".getBytes(java.nio.charset.StandardCharsets.US_ASCII);
    private static final byte[] PROGRAM_B = "fake-ttf-program-B".getBytes(java.nio.charset.StandardCharsets.US_ASCII);
    ...
    private static String siblingSubsetsBase64(boolean includeSecond) throws Exception {
        try (PDDocument doc = new PDDocument()) {
            ...
            fonts.setItem(
                    ...
                    subsetFontDict(doc, "AAAAAC+FakeGaramond", PROGRAM_A, toUnicodeCmap(new int[][] {
                        {0x21, 0xE001}, {0x22, 0xE000}
                    })));
            if (includeSecond) {
                fonts.setItem(
                        org.apache.pdfbox.cos.COSName.getPDFName("TTB"),
                        subsetFontDict(doc, "AAAAAG+FakeGaramond", PROGRAM_B, toUnicodeCmap(new int[][] {
                            {0x21, 0xE000}, {0x22, 0xE002}
                        })));
            }
            org.apache.pdfbox.pdmodel.PDResources resources = new org.apache.pdfbox.pdmodel.PDResources();
    ...
    private static EncodeCharcodesRequest siblingRequest(String base64, String fontName, String fontSha256) {
        EncodeCharcodesRequest req = new EncodeCharcodesRequest();
        req.setPdfBase64(base64);
        req.setPageIndex(0);
    ...
    void fontProgramHashSelectsTheExactSubset() throws Exception {
        ...
        EncodeCharcodesResponse viaA = controller
                .encodeCharcodes(siblingRequest(base64, "FakeGaramond", sha256Hex(PROGRAM_A)))
                .getBody();
        ...
        EncodeCharcodesResponse viaB = controller
                .encodeCharcodes(siblingRequest(base64, "FakeGaramond", sha256Hex(PROGRAM_B)))
                .getBody();
    ...
    void ambiguousStrippedNameRefusesToGuessBetweenSiblingSubsets() throws Exception {
        ...
        EncodeCharcodesResponse body = controller()
                .encodeCharcodes(siblingRequest(siblingSubsetsBase64(true), "FakeGaramond", null))
                .getBody();
        assertThat(body).isNotNull();
        assertThat(body.getError()).contains("no font");
        assertThat(body.getCharcodes()).isNull();
    ...
    void exactTaggedNameStillSelectsItsSubset() throws Exception {
        ...
        EncodeCharcodesResponse body = controller()
                .encodeCharcodes(siblingRequest(siblingSubsetsBase64(true), "AAAAAG+FakeGaramond", null))
                .getBody();
        assertThat(body).isNotNull();
        assertThat(body.getError()).isNull();
    ...
    void strippedNameStillWorksWhenUnambiguous() throws Exception {
        ...
        EncodeCharcodesResponse body = controller()
                .encodeCharcodes(siblingRequest(siblingSubsetsBase64(false), "FakeGaramond", null))
                .getBody();
        assertThat(body).isNotNull();
        assertThat(body.getError()).isNull();
    ...
    void staleHashFallsBackToNameMatching() throws Exception {
        ...
        EncodeCharcodesResponse body = controller()
                .encodeCharcodes(siblingRequest(
    ...
    private static String cacheIdentityPairBase64(String baseName, byte[] program) throws Exception {
        try (PDDocument doc = new PDDocument()) {
            PDPage page = new PDPage();
            doc.addPage(page);
            org.apache.pdfbox.cos.COSDictionary fonts = new org.apache.pdfbox.cos.COSDictionary();
            fonts.setItem(
                    ...
                    subsetFontDict(doc, baseName, program, toUnicodeCmap(new int[][] {{0x21, 0xE001}, {0x22, 0xE000}
                    })));
            fonts.setItem(
                    org.apache.pdfbox.cos.COSName.getPDFName("C2"),
                    subsetFontDict(doc, baseName, program, toUnicodeCmap(new int[][] {{0x21, 0xE002}, {0x22, 0xE003}
                    })));
            org.apache.pdfbox.pdmodel.PDResources resources = new org.apache.pdfbox.pdmodel.PDResources();
            resources.getCOSObject().setItem(org.apache.pdfbox.cos.COSName.FONT, fonts);
            page.setResources(resources);
    ...
    void unnamedFontsSharingOneProgramDoNotShareACachedMap() throws Exception {
        ...
        EncodeCharcodesResponse first = controller
        ...
        EncodeCharcodesResponse second = controller
    ...
    private static String formXObjectFontBase64() throws Exception {
        try (PDDocument doc = new PDDocument()) {
            ...
            org.apache.pdfbox.pdmodel.PDResources innerResources = new org.apache.pdfbox.pdmodel.PDResources();
            innerResources.put(
                    org.apache.pdfbox.cos.COSName.getPDFName("F1"),
                    new PDType1Font(Standard14Fonts.FontName.HELVETICA));
            inner.setResources(innerResources);

            org.apache.pdfbox.pdmodel.PDResources outerResources = new org.apache.pdfbox.pdmodel.PDResources();
    ...
    private static String cyclicFormXObjectsBase64() throws Exception {
        try (PDDocument doc = new PDDocument()) {
            ...
            org.apache.pdfbox.pdmodel.PDResources resA = new org.apache.pdfbox.pdmodel.PDResources();
            org.apache.pdfbox.pdmodel.PDResources resB = new org.apache.pdfbox.pdmodel.PDResources();
