...
@DisplayName("PdfImageRemovalService Tests")
class PdfImageRemovalServiceTest {
    ...
    @Nested
    @DisplayName("Image Removal Tests")
    class ImageRemovalTests {

        @Test
        @DisplayName("Removes images from PDF with images present")
        ...
        @Test
        @DisplayName("Does not modify PDF when no images are present")
        ...
        @Test
        @DisplayName("Removes images from PDF with multiple pages")
