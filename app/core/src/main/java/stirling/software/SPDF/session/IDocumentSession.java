...
/**
 * Represents a session for a single open document. A session encapsulates the document model,
 * selection state, undo history, and other runtime information needed for editing.
 */
public interface IDocumentSession {
    ...
    /**
     * Disposes this session, releasing all resources. After disposal, the session should not be
     * used.
     *
