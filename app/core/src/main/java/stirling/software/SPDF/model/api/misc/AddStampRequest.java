...
public class AddStampRequest extends PDFWithPageNums {
    ...
    @Schema(
            description = "Position for stamp placement based on a 1-9 grid (1: bottom-left, 2: bottom-center,"
    ...
    @Schema(
            description = "Override X coordinate for stamp placement. If set, it will override the"
    ...
    @Schema(
            description = "Override Y coordinate for stamp placement. If set, it will override the"
                    + " position-based calculation. Negative value means no override.",
            defaultValue = "-1",
            requiredMode = Schema.RequiredMode.REQUIRED)
