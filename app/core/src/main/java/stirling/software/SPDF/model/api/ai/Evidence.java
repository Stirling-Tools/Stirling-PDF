 ...
 * @param unautablePages   Pages that were requested but could not be fulfilled — e.g. OCR
 *                         was asked for but is not yet wired. The Auditor echoes these into
 *                         {@link Verdict#unautablePages()} so the client knows coverage is
 *                         incomplete.
 */
