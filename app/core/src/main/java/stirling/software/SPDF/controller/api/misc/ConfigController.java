...
public class ConfigController {
    ...
    public ResponseEntity<Map<String, Object>> getAppConfig(HttpServletRequest request) {
        ...
        try {
            ...
            configData.put(
                    "enableMobileSignature", applicationProperties.getSystem().isEnableMobileSignature());
            configData.put(
            ...
            configData.put("enableEasterEggs", applicationProperties.getSystem().isEnableEasterEggs());
            ...
            configData.put(
                    ...
                    applicationContext
                            .getEnvironment()
                            .getProperty("stirling.billing.account-link.enabled", Boolean.class, false));
