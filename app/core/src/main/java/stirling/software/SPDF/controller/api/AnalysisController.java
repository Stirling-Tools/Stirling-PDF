...
public class AnalysisController {
    ...
    public Map<String, Integer> getPageCount(@ModelAttribute PdfRequest file) throws IOException {
    ...
    public Map<String, Object> getBasicInfo(@ModelAttribute PdfRequest file) throws IOException {
        try (PDDocument document = pdfDocumentFactory.load(file.getFileInput())) {
    ...
    public Map<String, String> getDocumentProperties(@ModelAttribute PdfRequest file)
            throws IOException {
    ...
    public List<Map<String, Float>> getPageDimensions(@ModelAttribute PdfRequest file)
            throws IOException {
        try (PDDocument document = pdfDocumentFactory.load(file.getFileInput())) {
    ...
    public Map<String, Object> getFormFields(@ModelAttribute PdfRequest file) throws IOException {
        try (PDDocument document = pdfDocumentFactory.load(file.getFileInput())) {
    ...
    public Map<String, Object> getAnnotationInfo(@ModelAttribute PdfRequest file)
            throws IOException {
        try (PDDocument document = pdfDocumentFactory.load(file.getFileInput())) {
    ...
    public Map<String, Object> getFontInfo(@ModelAttribute PdfRequest file) throws IOException {
        try (PDDocument document = pdfDocumentFactory.load(file.getFileInput())) {
    ...
    public Map<String, Object> getSecurityInfo(@ModelAttribute PdfRequest file) throws IOException {
        try (PDDocument document = pdfDocumentFactory.load(file.getFileInput())) {
