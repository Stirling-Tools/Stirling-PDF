...
public abstract class CreateSignatureBase implements SignatureInterface {
    ...
    public CreateSignatureBase(KeyStore keystore, char[] pin, String requestedAlias)
            throws KeyStoreException, UnrecoverableKeyException, NoSuchAlgorithmException, IOException,
                    CertificateException {
        if (requestedAlias != null && !requestedAlias.isBlank() && keystore.containsAlias(requestedAlias)) {
     ...
     */
    private static Certificate[] resolveChain(KeyStore keystore, String alias) throws KeyStoreException {
