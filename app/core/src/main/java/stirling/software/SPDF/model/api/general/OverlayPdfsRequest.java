...
public class OverlayPdfsRequest extends PDFFile {
    ...
    @Schema(
            description = "An array of PDF files to be used as overlays on the base PDF. The order in"
                    + " these files is applied based on the selected mode.",
            requiredMode = Schema.RequiredMode.REQUIRED)
    private MultipartFile[] overlayFiles;

    @Schema(
            description = "The mode of overlaying: 'SequentialOverlay' for sequential application,"
    ...
    @Schema(
            description = "An array of integers specifying the number of times each corresponding overlay"
