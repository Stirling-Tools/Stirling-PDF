...
public class JobController {
    ...
    @Operation(
            ...
            description = "Force-expires this node's finished jobs instead of waiting out the retention"
    ...
    public ResponseEntity<?> cleanupFinishedJobs() {
        TaskManager.CleanupSummary summary = taskManager.cleanupFinishedJobsNow(this::validateJobAccess);
        log.info(
