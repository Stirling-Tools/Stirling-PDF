...
public class RequestUriUtilsTest {
    ...
    class StaticResourceTests {
        ...
        void testIsStaticResource() {
            ...
            assertTrue(
                    RequestUriUtils.isStaticResource("/css/styles.css"),
        ...
        void testEdgeCases() {
            ...
            assertTrue(
                    RequestUriUtils.isStaticResource("/logo.png"),
                    "PNG (lowercase) should be static");
            assertTrue(
                    RequestUriUtils.isStaticResource("/icon.svg"),
                    "SVG (lowercase) should be static");
    ...
    class TrackableResourceTests {
        ...
        void testIsTrackableResource() {
            ...
            assertTrue(
                    RequestUriUtils.isTrackableResource("/login"),
                    "Login page should be trackable");
            assertTrue(
        ...
        void testEdgeCases() {
            ...
            // Test String "null" as a path
            assertTrue(
                    RequestUriUtils.isTrackableResource("null"),
                    "String 'null' should be trackable");
