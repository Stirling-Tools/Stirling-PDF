...
class RequestUriUtilsTest {
    ...
    void testIsPublicAuthEndpoint_shareLinkWithContextPath() {
        assertTrue(RequestUriUtils.isPublicAuthEndpoint("/app/share/00dcac3a-fc7a-4989-9c4f-97745484d62f", "/app"));
    }
    ...
    void testIsPublicAuthEndpoint_shareLinkWithInvalidTokenLength() {
        ...
        assertFalse(RequestUriUtils.isPublicAuthEndpoint("/share/00dcac3a-fc7a-4989-9c4f-97745484d62fa", ""));
    }
    ...
    void testIsPublicAuthEndpoint_inviteUppercaseUuidNotPublic() {
        ...
        assertFalse(RequestUriUtils.isPublicAuthEndpoint("/invite/06A20E7E-2E35-4E26-BE7D-2DCE14F28F12", ""));
    }

    @Test
    void testIsPublicAuthEndpoint_inviteWrongLengthNotPublic() {
        // 35-char and 37-char UUID-like tokens are not valid UUIDs
        assertFalse(RequestUriUtils.isPublicAuthEndpoint("/invite/06a20e7e-2e35-4e26-be7d-2dce14f28f1", ""));
        assertFalse(RequestUriUtils.isPublicAuthEndpoint("/invite/06a20e7e-2e35-4e26-be7d-2dce14f28f122", ""));
    }

    @Test
    void testIsPublicAuthEndpoint_inviteWrongGroupingNotPublic() {
        // Groups of 8-4-4-4-4 must not be shifted around (e.g. 4-4-4-4-8)
        assertFalse(RequestUriUtils.isPublicAuthEndpoint("/invite/06a2-0e7e-2e35-4e26-be7d2dce14f28f12", ""));
    }
    ...
    void testIsPublicAuthEndpoint_inviteTokenInvalidCharsNotPublic() {
        ...
        assertFalse(RequestUriUtils.isPublicAuthEndpoint("/invite/06a20e7e-2e35-4e26-be7d-2dce14f28f1g", ""));
    }
}
