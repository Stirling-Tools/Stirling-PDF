...
public class GeneralUtilsTest {
    ...
    class AllAndBasicNTests {
        ...
        void testParsePageListWithAll() {
            ...
            assertEquals(
                    List.of(0, 1, 2, 3, 4),
                    result,
                    "'All' keyword should return all pages zero-based");
        }
        ...
        void testParsePageListWithAllOneBased() {
            ...
            assertEquals(
                    List.of(1, 2, 3, 4, 5),
                    result,
                    "'All' keyword should return all pages one-based");
        }
        ...
        void nFunc() {
            ...
            assertEquals(
                    List.of(1, 2, 3, 4, 5),
                    result,
                    "'n' keyword should return all pages one-based");
        }
    }
    ...
    class AdvancedNFunctionTests {
        ...
        void nFuncAdvanced2() {
            ...
            assertEquals(
                    List.of(3, 7), result, "'4n-1' should select (4n minus 1) pages one-based");
        }
        ...
        void nFunc_spaces() {
            ...
            assertEquals(
                    ...
                    result,
                    "'n + 1' with spaces should return adjusted pages one-based");
        }
        ...
        void nFunc_consecutive_Ns_nnn() {
            ...
            assertEquals(
                    List.of(1, 8),
                    result,
                    "'nnn' should return pages at specified intervals one-based");
        }
        ...
        void nFunc_consecutive_Ns_nn() {
            ...
            assertEquals(
                    List.of(1, 4, 9),
                    result,
                    "'nn' should return pages at specified intervals one-based");
        }
        ...
        void nFunc_opening_closing_round_brackets() {
            ...
            assertEquals(
                    List.of(2, 6),
                    result,
                    "'(n-1)(n-2)' should return combined adjusted pages one-based");
        }
        ...
        void nFunc_opening_round_brackets() {
            ...
            assertEquals(
                    List.of(2, 4, 6, 8),
                    result,
                    "'2(n-1)' should return multiples of 2 adjusted one-based");
        }
        ...
        void nFunc_closing_round_brackets() {
            ...
            assertEquals(
                    List.of(2, 4, 6, 8),
                    result,
                    "'(n-1)2' should return multiples of 2 adjusted one-based");
        }
        ...
        void nFunc_function_surrounded_with_brackets() {
            ...
            assertEquals(
                    ...
                    result,
                    "'(n-1)' should return adjusted pages one-based");
        }
        ...
        void nFuncAdvanced4() {
            ...
            assertEquals(
                    List.of(5, 7, 9), result, "'3+2n' should return specified pages one-based");
        }
    ...
    class RangeParsingTests {
        ...
        void testParsePageListWithRangeOneBasedOutputFull() {
            ...
            assertEquals(
                    List.of(1, 3, 7, 8), result, "'1,3,7-8' one-based should return correct pages");
        }

        @Test
        @DisplayName(
                "Parsing mixed pages and ranges with out-of-range one-based inputs returns only valid pages")
        void testParsePageListWithRangeOneBasedOutputFullOutOfRange() {
            ...
            assertEquals(
                    List.of(1, 3),
                    result,
                    "'1,3,7-8' with out-of-range should return only valid pages one-based");
        }
        ...
        void testParsePageListWithRangeZeroBaseOutputFull() {
            ...
            assertEquals(
                    List.of(0, 2, 6, 7),
                    result,
                    "'1,3,7-8' zero-based should return correct pages");
        }
    }
}
