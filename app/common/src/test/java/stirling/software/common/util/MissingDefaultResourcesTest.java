        ...
        try (PDDocument document = org.apache.pdfbox.Loader.loadPDF(pdf)) {
            ...
            FormUtils.addNewFields(
                    ...
                    List.of(new FormUtils.NewFormFieldDefinition(
                            "note", null, "text", 0, 50f, 700f, 200f, 20f, null, null, null, null, null, null, null,
                            null, null, null)),
                    skipped);

            assertTrue(skipped.isEmpty(), "adding a plain text field should not be refused: " + skipped);
            assertEquals(1, FormUtils.extractFormFields(document).size(), "the field should be in the document");
        }
    }
}
