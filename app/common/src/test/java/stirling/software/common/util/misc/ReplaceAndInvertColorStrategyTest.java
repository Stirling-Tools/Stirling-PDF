...
class ReplaceAndInvertColorStrategyTest {
    ...
    class ConstructorAndAccessorTests {
        ...
        void testGettersAndSetters() {
            ...
            // Act
            ReplaceAndInvertColorStrategy strategy =
                    new ConcreteReplaceAndInvertColorStrategy(
                            mockFile1, ReplaceAndInvert.CUSTOM_COLOR);
            ...
            assertEquals(
                    ...
                    strategy.getReplaceAndInvert(),
                    "Initial ReplaceAndInvert should match");
            ...
            assertEquals(
                    ...
                    strategy.getReplaceAndInvert(),
                    "Updated ReplaceAndInvert should match");
        }
    }
    ...
    class ReplaceMethodTests {
        ...
        void testReplaceWithEmptyContent() throws IOException {
            ...
            ReplaceAndInvertColorStrategy strategy =
                    new ConcreteReplaceAndInvertColorStrategy(emptyFile, replaceAndInvert);
