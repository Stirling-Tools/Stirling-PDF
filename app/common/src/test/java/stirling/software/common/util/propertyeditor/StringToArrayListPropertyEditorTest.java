...
class StringToArrayListPropertyEditorTest {
    ...
    class ValidInputTests {
        ...
        @Test
        @DisplayName("Set as text parses valid JSON array to List correctly")
        ...
        @Test
        @DisplayName("Set as text handles multiple items in JSON array correctly")
        ...
        @Test
        @DisplayName("Set as text treats single JSON object as List with one item")
    ...
    class EmptyAndNullInputTests {
        ...
        @Test
        @DisplayName("Set as text returns empty List for empty string")
        ...
        @Test
        @DisplayName("Set as text returns empty List for null string")
    ...
    class InvalidInputTests {
        ...
        @Test
        @DisplayName("Set as text throws IllegalArgumentException for invalid JSON structure")
