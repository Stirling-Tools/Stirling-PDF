...
class EndpointConfigurationTest {
    ...
    void endpointKeyForUriExtractsSimpleKebab() {
        ...
        assertEquals("compress-pdf", EndpointConfiguration.endpointKeyForUri("/api/v1/misc/compress-pdf"));
        assertEquals("add-watermark", EndpointConfiguration.endpointKeyForUri("/api/v1/security/add-watermark"));
    }
    ...
    void endpointKeyForUriComposesConvertEndpoints() {
        ...
        assertEquals("pdf-to-word", EndpointConfiguration.endpointKeyForUri("/api/v1/convert/pdf/word"));
        assertEquals("html-to-pdf", EndpointConfiguration.endpointKeyForUri("/api/v1/convert/html/pdf"));
    }
