...
public class InProcessRateLimitStore implements RateLimitStore {
    ...
    private final Map<String, Bucket> buckets =
            Collections.synchronizedMap(new LinkedHashMap<String, Bucket>(256, 0.75f, true) {
                @Override
    ...
    public RateLimitDecision tryConsume(String bucketKey, long capacity, Duration refillPeriod) {
        ...
        Bucket bucket = buckets.computeIfAbsent(compositeKey, k -> buildBucket(capacity, refillPeriod));
