...
SUMMARY_SYSTEM_PROMPT = (
    ...
    "- Call search_knowledge AT MOST THREE TIMES. Typically one or two calls is enough.\n"
    "- Do NOT try to read the entire document via many small searches. For long documents, "
    "accept that you are summarising from a sample, not the whole text.\n"
    "- If the user provided a focus, tailor your search queries to it.\n"
    "\n"
    "Length:\n"
