...
class AddStampParams(ApiModel):
    ...
    custom_margin: CustomMargin1 | None = Field(
        CustomMargin1.medium, description="Specifies the margin size for the stamp."
    )
...
class AddWatermarkParams(ApiModel):
    alphabet: Alphabet1 | None = Field(Alphabet1.roman, description="The selected alphabet")
