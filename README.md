...
This project uses [Task](https://taskfile.dev/) as a unified command runner for all build, dev, and test commands. Run `task setup` to get started, or see the [Developer Guide](DeveloperGuide.md) for full details.
