...
| Basque (Euskara) (eu_ES)                     | ![19%](https://geps.dev/progress/19)   |
...
| Czech (Česky) (cs_CZ)                        | ![35%](https://geps.dev/progress/35)   |
| Danish (Dansk) (da_DK)                       | ![31%](https://geps.dev/progress/31)   |
| Dutch (Nederlands) (nl_NL)                   | ![31%](https://geps.dev/progress/31)   |
| English (English) (en_GB)                    | ![100%](https://geps.dev/progress/100) |
| English (US) (en_US)                         | ![100%](https://geps.dev/progress/100) |
| French (Français) (fr_FR)                    | ![83%](https://geps.dev/progress/83)   |
| German (Deutsch) (de_DE)                     | ![85%](https://geps.dev/progress/85)   |
| Greek (Ελληνικά) (el_GR)                     | ![35%](https://geps.dev/progress/35)   |
| Hindi (हिंदी) (hi_IN)                          | ![35%](https://geps.dev/progress/35)   |
| Hungarian (Magyar) (hu_HU)                   | ![38%](https://geps.dev/progress/38)   |
| Indonesian (Bahasa Indonesia) (id_ID)        | ![31%](https://geps.dev/progress/31)   |
| Irish (Gaeilge) (ga_IE)                      | ![35%](https://geps.dev/progress/35)   |
| Italian (Italiano) (it_IT)                   | ![85%](https://geps.dev/progress/85)   |
| Japanese (日本語) (ja_JP)                    | ![63%](https://geps.dev/progress/63)   |
| Korean (한국어) (ko_KR)                      | ![35%](https://geps.dev/progress/35)   |
| Norwegian (Norsk) (no_NB)                    | ![33%](https://geps.dev/progress/33)   |
| Persian (فارسی) (fa_IR)                      | ![34%](https://geps.dev/progress/34)   |
| Polish (Polski) (pl_PL)                      | ![37%](https://geps.dev/progress/37)   |
| Portuguese (Português) (pt_PT)               | ![35%](https://geps.dev/progress/35)   |
| Portuguese Brazilian (Português) (pt_BR)     | ![84%](https://geps.dev/progress/84)   |
| Romanian (Română) (ro_RO)                    | ![29%](https://geps.dev/progress/29)   |
| Russian (Русский) (ru_RU)                    | ![84%](https://geps.dev/progress/84)   |
| Serbian Latin alphabet (Srpski) (sr_LATN_RS) | ![38%](https://geps.dev/progress/38)   |
...
| Swedish (Svenska) (sv_SE)                    | ![34%](https://geps.dev/progress/34)   |
...
| Turkish (Türkçe) (tr_TR)                     | ![38%](https://geps.dev/progress/38)   |
| Ukrainian (Українська) (uk_UA)               | ![37%](https://geps.dev/progress/37)   |
